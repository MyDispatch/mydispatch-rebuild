          ...
          {invoices.length === 0 ? (
            ...
            invoices.slice(0, 10).map((invoice: any) => (
              <TableRow key={invoice.id}>
                <TableCell className="font-medium text-slate-900">{invoice.id.slice(0, 8)}</TableCell>
                <TableCell className="text-slate-900">{formatCurrency(invoice.price || 0)}</TableCell>
                <TableCell>
                ...
                <TableCell className="text-slate-600">{format(new Date(invoice.created_at), 'dd.MM.yyyy')}</TableCell>
              </TableRow>
            ))
          )}
        </TableBody>
