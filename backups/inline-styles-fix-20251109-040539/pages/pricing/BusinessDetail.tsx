...
export default function BusinessDetail() {
  ...
  return (
    <MarketingLayout currentPage="pricing">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-8">
              Alle Starter-Features plus Partner-Netzwerk, Kunden-Portal, 
              Statistiken, API-Zugang und vieles mehr. Unbegrenzte Fahrzeuge 
              und Fahrer – perfekt für mittelgroße Betriebe.
            </p>
      ...
      >
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 mb-6">
            ... und alle Starter-Features: GPS-Tracking, Auftragsverwaltung, 
            Angebote & Rechnungen, Kunden-/Fahrerverwaltung, Info-Landingpage
          </p>
        </div>
      </V28MarketingSection>
      ...
      >
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="p-8 bg-slate-50 rounded-2xl border border-slate-200">
            ...
            <p className="text-slate-600">
              Sie haben mehr als 3 Fahrzeuge und benötigen erweiterte Features 
              wie Partner-Netzwerk, Statistiken und unbegrenzte Fahrzeug-/Fahrerverwaltung.
            </p>
          </div>
          <div className="p-8 bg-slate-50 rounded-2xl border border-slate-200">
            <div className="text-4xl mb-4">🤝</div>
            ...
            <p className="text-slate-600">
              Sie arbeiten mit Partner-Unternehmen zusammen und möchten Aufträge 
              im Netzwerk vergeben und verwalten.
            </p>
          </div>
        </div>
      </V28MarketingSection>
        ...
        <div className="max-w-4xl mx-auto">
          <V28MarketingCard>
            <p className="text-lg text-slate-600 mb-6">
              ...
              White-Label-Landingpages, Custom-Integrationen oder einen dedizierten 
              Account Manager benötigen, ist der <strong className="text-slate-900">Enterprise-Tarif</strong> die richtige Wahl.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/pricing/enterprise">
                <V28Button variant="secondary">
                  Enterprise-Tarif ansehen
                </V28Button>
              </Link>
              <Link to="/pricing">
                <V28Button variant="secondary">
      ...
      <V28MarketingSection 
        background="white" 
        title="Häufige Fragen zum Business-Tarif"
      >
      ...
      <V28MarketingSection background="canvas">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-lg text-slate-600 mb-8">
            Registrieren Sie sich jetzt und nutzen Sie alle Business-Features 
            für Ihr wachsendes Taxi- oder Mietwagenunternehmen.
          </p>
          <Link to="/auth?tariff=business">
            <V28Button variant="primary" size="lg" className="w-full">
