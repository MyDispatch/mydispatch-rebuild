...
import { 
  MessageSquare, Phone, Video, Plus, Users, Shield, Info, Mail, 
  FileText, FileEdit, Send, Save, Search 
} from 'lucide-react';
    ...
    <>
              ...
              <Card className="border-2 border-primary">
                ...
                <CardContent className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      Um den Team-Chat nutzen zu können, benötigen wir Ihre Einwilligung gemäß DSGVO.
                    </AlertDescription>
                  </Alert>
                        ...
                        {selectedConversation ? (
                          ...
                          <Card className="h-[calc(100vh-280px)] flex items-center justify-center">
                            <CardContent className="text-center">
                              ...
                              <h3 className="text-lg font-semibold mb-2">Keine Unterhaltung ausgewählt</h3>
                          ...
                          <Card key={template.id} className="hover:shadow-md transition-shadow">
                            ...
                            <CardContent className="space-y-3">
                              <div className="bg-muted/30 p-3 rounded-md text-sm">
                                <p className="text-muted-foreground italic line-clamp-2">{template.body}</p>
                              </div>
            ...
            <Card className="bg-muted/50">
              <CardContent className="pt-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                  <div>
                    <p><code className="bg-muted px-1 py-0.5 rounded text-xs">{'{company_name}'}</code> - {company?.name}</p>
                    <p><code className="bg-muted px-1 py-0.5 rounded text-xs">{'{company_address}'}</code> - Adresse</p>
                  </div>
                  <div>
                    <p><code className="bg-muted px-1 py-0.5 rounded text-xs">{'{customer_name}'}</code> - Kundenname</p>
                    <p><code className="bg-muted px-1 py-0.5 rounded text-xs">{'{pickup_address}'}</code> - Abholort</p>
                  </div>
                  <div>
                    <p><code className="bg-muted px-1 py-0.5 rounded text-xs">{'{price}'}</code> - Betrag</p>
                    <p><code className="bg-muted px-1 py-0.5 rounded text-xs">{'{date}'}</code> - Datum</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <Dialog open={editDocDialog} onOpenChange={setEditDocDialog}>
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
          ...
          <DialogFooter>
            <V28Button variant="secondary" onClick={() => setEditDocDialog(false)}>Abbrechen</V28Button>
      ...
      <Dialog open={editEmailDialog} onOpenChange={setEditEmailDialog}>
        <DialogContent className="max-w-2xl">
          ...
          <DialogFooter>
            <V28Button variant="secondary" onClick={() => setEditEmailDialog(false)}>Abbrechen</V28Button>
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium text-slate-600">Aktive Chats</span>
                <MessageSquare className="h-4 w-4 text-slate-400" />
              </div>
              <p className="text-2xl font-bold text-slate-900">{conversations.filter(c => !c.archived).length}</p>
            </div>

            <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium text-slate-600">E-Mail Vorlagen</span>
            ...
            <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium text-slate-600">Dokument-Vorlagen</span>
            ...
            <div className="p-3 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium text-green-700">Chat-Zustimmung</span>
