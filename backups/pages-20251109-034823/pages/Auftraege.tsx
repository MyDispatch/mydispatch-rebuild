      ...
      >
        ...
        <div className="relative w-full h-[200px] sm:h-[250px] lg:h-[300px] mb-6 rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-slate-100 to-slate-50">
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
            ...
            <p className="text-sm sm:text-base max-w-2xl text-slate-600">
  ...
  return (
    <>
      ...
      <StandardPageLayout
        ...
        footerContent={
          <div 
            className="p-4 rounded-lg text-xs sm:text-sm bg-slate-50"
          >
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            {selectedBookingForPartner && (
              <div className="p-4 rounded-lg space-y-2 text-sm bg-slate-50">
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs font-medium text-slate-600">Offene Aufträge</span>
