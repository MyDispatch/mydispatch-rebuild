...
serve(async (req) => {
  ...
  try {
    ...
    await supabase.from("knowledge_base").delete().eq("category", "tariff_definition");
    ...
    const pricingPlans = [
      {
        ...
        content: {
          ...
          name: "Starter",
          price_monthly: 39,
          price_annually: 374.4,
          savings_annually: 93.6,
          limits: {
            drivers: 3,
            vehicles: 3,
            users: 1,
      ...
      },
      {
        ...
        content: {
          ...
          name: "Business",
          price_monthly: 89,
          price_annually: 854.4,
          savings_annually: 213.6,
          limits: {
            drivers: 10,
            vehicles: 10,
            users: 3,
    ...
    const { data, error } = await supabase.from("knowledge_base").insert(pricingPlans).select();
