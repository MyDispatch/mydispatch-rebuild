-- ============================================================================
-- SECURITY HARDENING PART 2 (COMPLETE RESET): Apply Role-Based Access Controls
-- ============================================================================
...
DROP POLICY IF EXISTS "Admins can view financial data" ON companies;
...
DROP POLICY IF EXISTS "Authorized staff can view customers" ON customers;
DROP POLICY IF EXISTS "Authorized staff can insert customers" ON customers;
DROP POLICY IF EXISTS "Authorized staff can update customers" ON customers;
