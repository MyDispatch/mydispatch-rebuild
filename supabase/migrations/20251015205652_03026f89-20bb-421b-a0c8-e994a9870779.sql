-- ==================================================================================
-- V18.1 OPTIMIERUNGEN: Database Performance Indexes (FINAL)
-- ==================================================================================
-- Datum: 15.10.2025
...
-- 6. Audit Logs Tabelle (ohne Policies, da bereits vorhanden)
...
-- RLS nur wenn noch nicht vorhanden
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'filter_presets'
  ) THEN
