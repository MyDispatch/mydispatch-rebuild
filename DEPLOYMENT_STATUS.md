...
**Pascal, du kannst das Vercel Dashboard prüfen, um den Build-Status zu sehen. Das Deployment sollte automatisch laufen.**
...
2. **Migrationen ausführen:**
   ...
   - SQL Editor → Migrationen ausführen

3. **Edge Functions deployen:**
   - Via Supabase CLI oder Dashboard
