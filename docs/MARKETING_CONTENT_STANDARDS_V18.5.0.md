# MARKETING CONTENT STANDARDS V18.5.0
...
Professionelle Content-Standards für MyDispatch Marketing-Materialien nach deutschen Rechts-, SEO- und Qualitätsstandards.
...
- Anglizismen ohne deutschen Bezug
...
- Deutsche Fachbegriffe ("Fuhrparkverwaltung" statt "Fleet Management")
...
Stil: text-wrap: balance

Beispiel:
"MyDispatch – Die führende Software für Taxi- und Mietwagenunternehmen"
```
...
Beispiel:
"Intelligente Auftragsverwaltung für 30% mehr Effizienz"
```
...
4. **Konsistenz:** Gleiche CTAs = gleicher Text
...
Beispiel:
"MyDispatch hat unsere Disposition revolutioniert. 30% Zeitersparnis im ersten Monat!"
– Michael Schmidt, Geschäftsführer, Taxi München GmbH
```
...
/* Body Text */
p {
  text-wrap: pretty; /* Keine Witwen/Waisen */
...
- [ ] Widerrufsrecht erwähnt (bei Abos)
...
"100% Umsatzsteigerung garantiert!"
→ Irreführende Versprechen, rechtlich bedenklich

"Ab 19€/Monat*" (*bei 24 Monaten Laufzeit)
→ Versteckte Bedingungen, intransparent
```
...
"Bis zu 30% Zeitersparnis durch intelligente Disposition"
→ Relativ, realistisch

"39 €/Monat im Starter-Tarif. Monatlich kündbar."
→ Transparent, klar
```
...
**SYSTEMWEITE VORGABE - BEI ALLEN MARKETING-INHALTEN ANWENDEN!**
