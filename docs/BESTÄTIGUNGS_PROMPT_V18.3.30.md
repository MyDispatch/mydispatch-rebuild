...
Ich bin der Auftraggeber, nicht der Fachmann. Die **volle Verantwortung** für die **100% fehlerfreie, qualitativ hochwertigste und zukunftssicherste Umsetzung** liegt ausschließlich bei Ihnen.
...
Alle folgenden Arbeiten erfolgen strikt nach dem **Best-Lösungs-Prinzip**: Es wird proaktiv die **robusteste, präventivste und zukunftssicherste Lösung** (nach "Corporate Standard", siehe Phase 3C) implementiert, auch wenn dies über die explizite Anforderung hinausgeht.
...
- ✅ GitHub PR Comments mit strukturiertem Feedback
...
1. **Spezifikationsbasierte Code-Prüfung (Line-by-Line Audit):**
   Prüfbasis ist Phase 3B/3C. Führen Sie eine tiefgehende, zeilenweise Prüfung des gesamten Systems durch.

2. **Fehleranalyse & Kausale Ursachenbehebung (Root-Cause-Fixing):**
   **Lokalisieren Sie alle Fehler.** Beheben Sie niemals nur das Symptom, sondern **immer und ausnahmslos die grundlegende Fehlerursache (Root Cause)** sowie alle damit verbundenen Abhängigkeiten im gesamten System.

3. **Iterative Verifizierung:**
   Wiederholen Sie den gesamten Prüfvorgang, bis der Bereich nachweislich und vollständig (100%) fehlerfrei ist.
...
- ✅ `.github/workflows/ai-code-review.yml` - Automated Reviews
...
1. **Vorbereitung:**
   Führen Sie Phase 2A durch. Konsultieren Sie die AWG-Wissensbasis. Stellen Sie sicher, dass Spezifikationen und Konzepte für den Zielbereich definiert sind oder definieren Sie diese.

2. **Ziel-Bereiche (Scope):**
   Sanieren Sie alle noch fehlerhaften oder nicht-konformen Seiten/Bereiche, insbesondere: Öffentliche Seiten / Portalseiten, Landingpage der Unternehmer, Fahrer-Portal, Kunden-Portal.
...
- [ ] Vollständige Logger-Migration (Batch-Processing)
...
✅ Logger-Migration: 15+ Dateien (10% von 192 Statements)
✅ KI-Integration: AI Code Review deployed & active
✅ Dokumentation: 5+ neue/aktualisierte Docs
✅ Compliance: Landingpage 100% konform
```
