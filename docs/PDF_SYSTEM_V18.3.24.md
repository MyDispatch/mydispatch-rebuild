...
<div class="dsgvo-info">
  ...
  Diese Rechnung enthält personenbezogene Daten, die gemäß 
  Art. 6 Abs. 1 lit. b DSGVO zur Vertragserfüllung verarbeitet werden. 
  Bei Fragen: datenschutz@my-dispatch.de
</div>
```
