...
export const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    protected: true,
    layout: "main",
    meta: { title: "Aufträge", icon: FileText },
  },
...
_(Siehe Haupt-Optimierungsplan - Mobile-First, Bundle-Size, Code-Cleanup, Master-Dashboard, GPS-Tracking, Performance, Finale QA)_
