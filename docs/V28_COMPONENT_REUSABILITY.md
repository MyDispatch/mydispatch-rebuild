...
<V28MarketingCard className="hover:shadow-2xl hover:scale-[1.01]">
  ...
  <h3 className="font-sans text-lg font-semibold mb-2 mt-4 text-slate-900">Feature Title</h3>
  <p className="font-sans text-sm leading-relaxed text-slate-600">Feature Description</p>
</V28MarketingCard>
```
