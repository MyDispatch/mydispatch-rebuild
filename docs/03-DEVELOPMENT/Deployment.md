...
> **Deployment & CI/CD für MyDispatch**  
> **Version:** 18.5.0  
...
2. Secrets hinzufügen:
   - `TEST_USER_EMAIL`
   - `TEST_USER_PASSWORD`
   - `GOOGLE_MAPS_API_KEY` (falls benötigt)
...
1. Lovable Dashboard → Project Settings
2. Version History → Vorherige Version auswählen
3. "Restore" klicken
...
# 5. PR Review + Merge
# → Auto-Deploy nach Staging (Preview)

# 6. Nach Approval: Merge to main
# → Auto-Deploy nach Production
```
...
2. **Logs prüfen:** Lovable Cloud → Backend → Logs
...
**KRITISCH:** Diese Deployment-Prozesse sind ZWINGEND für Production-Deployments.
