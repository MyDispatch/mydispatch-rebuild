...
7. *Schichtzettel & Dokumentenverwaltung - nicht vorhanden, daher übersprungen*
...
9. *Weitere Pages (AIChatbot, MobileApps, etc.) - nicht vorhanden, daher übersprungen*
...
<V28MarketingSection
  background="canvas"
  title="Funktionen"
  description="Alle Features im Detail"
>
  {/* Content */}
</V28MarketingSection>
```
