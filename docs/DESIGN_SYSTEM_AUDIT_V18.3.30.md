...
```css
--video-background: 225 31% 15% /* Dunkler Hintergrund für Video */ --video-foreground: 0 0% 100%
  /* Weiß für Kontrast */;
```
...
```tsx
<Dialog>
  <div className="bg-video-background text-video-foreground">{/* Video-Player */}</div>
</Dialog>
```
