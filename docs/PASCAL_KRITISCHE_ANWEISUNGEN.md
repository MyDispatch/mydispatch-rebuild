...
**Status:** ✅ ABSOLUTE VORGABE  
**Zweck:** Kritische Anweisungen von Pascal für alle Arbeiten

---

## ⚠️ KRITISCHE ANWEISUNGEN - AUSWENDIG KENNEN!
...
→ Finde alle Lücken
→ Schließe sie vollständig
→ Bedenke alle Abhängigkeiten
→ Biete Gesamtlösungen an
```
...
- ✅ Immer: Auswirkungen auf andere Bereiche prüfen
...
- ✅ Alle Aufgaben, Vorgaben, Regeln werden **ausnahmslos** mit den **immer gleichen und festen Werten** aus:
  ...
  - Regeln
  - Verboten
- ✅ Betrachtung: **logisch und vorausschauend**
...
✅ Optionale Verbesserung: Feature Y könnte auch noch implementiert werden (Vorteil: ...)
✅ Weitere wichtige Arbeit: Migration Z sollte noch ausgeführt werden
```
...
4. ✅ Schnellere/effektivere Gesamtlösungen finden
5. ✅ Systemweit denken
...
4. ✅ Hoher Anspruch, dauerhaft
5. ✅ Eigenständige Vorschläge ohne Nachfrage
...
Ich sollte:
1. ✅ Alle Vorgaben zur Authentication analysieren
2. ✅ Alle Lücken finden (auch in Abhängigkeiten)
3. ✅ Systemweit denken (Auth → User → Company → Permissions)
4. ✅ Alle Lücken vollständig schließen
5. ✅ Optionale Verbesserungen vorschlagen (z.B. "Optional: 2FA implementieren")
6. ✅ Feste Werte einhalten (Design-System, Coding Standards, etc.)
```
