...
**Vorher:**
```tsx
<a className="underline">  // ❌ VERBOTEN (V18.5.0)
  Alle Features vergleichen
</a>
```
**Nachher:**
```tsx
<a className="no-underline hover:text-secondary-hover transition-all">
  Alle Features vergleichen
</a>
```
...
**Nachher:**
```tsx
<a className="no-underline hover:text-secondary-hover transition-colors">
