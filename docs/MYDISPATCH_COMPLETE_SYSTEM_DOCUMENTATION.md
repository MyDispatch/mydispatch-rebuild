...
**Sekundäre Einnahmequellen (Roadmap):**
3. **API-Marketplace:**
...
**Zusatzservices (Business-Plan):**
6. GPS-Echtzeit-Tracking (Live-Karte, Routenverfolgung, Geofencing)
7. Partner-Netzwerk (Auftragsvergabe an Subunternehmer)
8. Erweiterte Analysen (Umsatz-Dashboards, Fahrzeugauslastung, Custom Reports)
9. API-Zugang (REST API, Webhooks, Integrationen)
...
<div style={{
  ...
  <h1>{company.name}</h1>
  <Button style={{ backgroundColor: company.secondary_color }}>
    Jetzt buchen
  </Button>
</div>
```
