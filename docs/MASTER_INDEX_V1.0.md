...
Dieses Dokument ist der **zentrale Einstiegspunkt** für ALLE MyDispatch-Dokumentation. Alle Dokumente sind nach HYPERION-Phasen kategorisiert.
...
1. [NEXIFY Wiki](./NEXIFY_WIKI_V1.0.md) ⭐ **START HERE** - Vollständiges Knowledge System
...
## 🔧 PHASE 1: Core Systems (API, State, Hooks)
...
## 🎨 PHASE 2: Assembly (Components, Pages, Design)
...
## ✅ PHASE 3: Validation (Tests, Security, Performance)
...
## 🚨 Quick Access (Most Used Docs)

### Fehlersuche & Debugging

- **Error Diagnosis:** [Fehlerdiagnose Framework](./FEHLERDIAGNOSE_FRAMEWORK_V1.0.md#2-fehlerdiagnose-checkliste)
- **Known Issues:** [NEXIFY Wiki - Critical Issues](./NEXIFY_WIKI_V1.0.md#🚨-critical-known-issues-priority-0)
...
- **API Calls:** [Abhängigkeiten Matrix](./ABHÄNGIGKEITEN_MATRIX_V1.0.md#1-direkte-abhängigkeiten-tier-1)
- **TanStack Query:** [HYPERION Phase 2](./HYPERION_PHASE_2_STATUS.md#📊-tanstack-query-adoption-status)
...
- **Wiki Load:** [NeXify Wiki - Load Command](./NEXIFY_WIKI_V1.0.md#🚨-mandatory-load-command)
...
Folgende Dokumente erfordern manuelle Updates nach Änderungen:
...
2. Fülle Sections aus (min. Version, Datum, Status)
3. Füge Link zu diesem Master Index hinzu
