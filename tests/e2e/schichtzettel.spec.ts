...
test.describe('Schichtzettel System - E2E Tests', () => {
  ...
  test('should display Schichtzettel page', async ({ page }) => {
    ...
    const kpiCards = page.locator('[data-kpi-card]').or(page.locator('text=/Offen|Genehmigt|Gesamt/'));
  ...
  test('should open create dialog', async ({ page }) => {
    ...
    const createButton = page.getByRole('button', { name: /neues schichtzettel|schichtzettel erstellen/i });
