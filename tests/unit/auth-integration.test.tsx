...
describe('Auth Integration Tests', () => {
  ...
  describe('Account Type & Permissions Integration', () => {
    it('should derive correct permissions for master account', () => {
      ...
      const isMaster = masterEmail === 'courbois1981@gmail.com' || masterEmail === 'master@my-dispatch.de';
    ...
    it('should derive correct permissions for normal account', () => {
      ...
      const isMaster = normalEmail === 'courbois1981@gmail.com' || normalEmail === 'master@my-dispatch.de';
