/* ==================================================================================
   V28 SWITCH COMPONENT V28.1 - WRAPPER FOR RADIX SWITCH
   ==================================================================================
   ✅ Wraps @radix-ui/react-switch
   ✅ Pure Tailwind Slate Styling
   ✅ Backward Compatible mit shadcn Switch API
   ================================================================================== */
...
const V28Switch = React.forwardRef<
...
V28Switch.displayName = SwitchPrimitives.Root.displayName;
