    ...
    items: [
      {
        ...
        content:
          "MyDispatch is a comprehensive dispatch management system for logistics and transportation.",
      },
      {
        value: "item-2",
        trigger: "How do I add drivers?",
        content:
          'Navigate to the Drivers section and click the "Add Driver" button to create new driver profiles.',
      },
      {
        value: "item-3",
