...
export const organizationSchema = {
  ...
  "sameAs": [
    COMPANY_INFO.ridehub.contact.websiteUrl
  ]
};
...
export const softwareApplicationSchema = {
  ...
  "description": "Professionelle Dispositionssoftware für Taxi- und Mietwagenunternehmen. DSGVO-konform, Made in Germany.",
  "featureList": [
  ...
  "releaseNotes": "V18.1: DetailDialog-System, Partner-Filter, Automatische Provisions-Berechnung, SEO-Optimierung"
};
