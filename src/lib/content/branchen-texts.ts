...
export const BRANCHEN_TEXTS = {
  ...
  common: {
    ...
    hero: {
      ...
      description:
        "Rechtssichere Disposition ohne Papierkram: PBefG-konforme Dokumentation, automatische Rechnungen und einfache Tagesabläufe. Made in Germany.",
    ...
    trust: {
      ...
      uptime: {
        ...
        tooltip:
          "Gemessene Uptime in den letzten 12 Monaten (Jahresmittel). Ausgenommen: geplante Wartungen.",
      },
      support: {
        label: "< 24h",
    ...
    legal: {
      pricing:
        "Alle Preise verstehen sich zzgl. der gesetzlichen Mehrwertsteuer. Vertragslaufzeit: Monatlich kündbar. Keine Mindestvertragslaufzeit.",
      pbefg:
        "MyDispatch erfüllt alle Anforderungen des Personenbeförderungsgesetzes (PBefG) für Taxi- und Mietwagenverkehr.",
      dsgvo:
        "DSGVO-konform. Alle Daten werden ausschließlich auf deutschen Servern gespeichert. Hosting: Google Cloud Platform (EU-Datacenter).",
      aiAct:
        'KI-Funktionen gemäß EU AI Act (Risikoklasse "Minimales Risiko"). Vollständige Transparenz über KI-Nutzung (Art. 52 AI Act).',
    },
  },
  ...
  taxi: {
    hero: {
      ...
      description:
        "PBefG § 51-konforme Dokumentation ohne Papierkram: Automatische Schichtberichte, P-Schein-Verwaltung und Taxameter-Anbindung. Vermeiden Sie täglich Bußgelder mit rechtssicherer Dokumentation.",
  ...
  mietwagen: {
    hero: {
      ...
      description:
        "PBefG § 49-konforme Rückkehrpflicht-Verwaltung ohne Papierkram: Automatische Dokumentation, digitale Voranmeldung und einfache Firmenkundenverwaltung. Über 180 Mietwagen-Services vermeiden Konzessionsprobleme mit MyDispatch.",
  ...
  limousinen: {
    hero: {
      ...
      description:
        "Rechtssichere Verwaltung ohne Papierkram: White-Label-Buchungsportal, automatische Chauffeur-Dokumentation und einfache VIP-Kundenverwaltung. Über 45 Limousinen-Services arbeiten professionell und rechtssicher mit MyDispatch.",
