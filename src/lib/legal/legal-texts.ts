...
export const COOKIE_BANNER = {
  ...
  categories: {
    essential: {
      ...
      description: 'Diese Cookies sind für die Grundfunktionen der Website erforderlich (z.B. Login, Warenkorb, Sicherheit).',
      required: true,
      examples: [
        'Session-Management',
        'Authentifizierung',
...
export const PBEFG_NOTICES = {
  bookingConfirmation: {
    ...
    legal: 'Diese Aufbewahrung dient der Nachweispflicht gegenüber den Behörden und erfolgt auf Grundlage von § 51 PBefG.'
  },
...
export const DSGVO_FORM_NOTICES = {
  dataCollection: {
    ...
    legal: 'Rechtsgrundlage: Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung) bzw. Art. 6 Abs. 1 lit. a DSGVO (Einwilligung)'
  },
...
export const getDSGVOFormNotice = (type: keyof typeof DSGVO_FORM_NOTICES) => DSGVO_FORM_NOTICES[type];
