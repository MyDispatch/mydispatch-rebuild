...
export const mainOnboardingSteps: OnboardingStep[] = [
  {
    ...
    description:
      "Wir zeigen Ihnen in 5 Minuten die wichtigsten Funktionen. Sie können die Tour jederzeit überspringen.",
    position: "center",
    tips: [
  ...
  },
  {
    ...
    description:
      "Hier sehen Sie alle wichtigen Kennzahlen auf einen Blick: Heutige Aufträge, verfügbare Fahrer, Umsatz und offene Rechnungen.",
  ...
  },
  {
    ...
    description:
      "Kritische Aufgaben werden hier automatisch angezeigt: Ablaufende Dokumente, überfällige Rechnungen, unzugewiesene Aufträge.",
  ...
  },
  {
    ...
    description:
      "In der Sidebar finden Sie alle Funktionen: Aufträge, Kunden, Fahrer, Fahrzeuge, Rechnungen und mehr.",
  ...
  },
  {
    ...
    description:
      'Bereit für Ihren ersten Auftrag? Klicken Sie auf "Neuer Auftrag" und wir führen Sie durch den Prozess.',
  ...
  },
  {
    ...
    description:
      "Brauchen Sie Unterstützung? Das Hilfe-System finden Sie in jedem Bereich. Detaillierte Erklärungen ohne Videos!",
  ...
  },
  {
    ...
    title: "🎉 Geschafft!",
    description:
      "Sie kennen jetzt die Grundlagen von MyDispatch. Viel Erfolg bei Ihrem Fahrdienst!",
    position: "center",
    tips: [
...
export const bookingsOnboardingSteps: OnboardingStep[] = [
  {
    ...
    description:
      "Hier verwalten Sie alle Ihre Fahrtaufträge - von der Erstellung bis zur Abrechnung.",
    position: "center",
    tips: [
  ...
  },
  {
    ...
    description:
      "Wählen Sie mehrere Aufträge aus und führen Sie Aktionen gleichzeitig aus: Status ändern, PDF-Export, E-Mail versenden.",
...
export const driversOnboardingSteps: OnboardingStep[] = [
  {
    ...
    description:
      "Verwalten Sie Ihre Fahrer und Fahrzeugflotte zentral - inklusive Dokumente und GPS-Tracking.",
    position: "center",
    tips: [
  ...
  },
  {
    ...
    description:
      "MyDispatch warnt automatisch bei ablaufenden Dokumenten: Führerschein, P-Schein, TÜV, Versicherungen.",
  ...
  },
  {
    ...
    title: "GPS-Tracking",
    description:
      "Sehen Sie in Echtzeit, wo sich Ihre Fahrer befinden - nur während aktiver Schichten (DSGVO-konform).",
