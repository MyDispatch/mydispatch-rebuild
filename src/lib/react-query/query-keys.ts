...
export const queryKeys = {
  ...
  statistics: {
    ...
    revenue: (period: string) => [...queryKeys.statistics.all, "revenue", period] as const,
    bookings: (period: string) => [...queryKeys.statistics.all, "bookings", period] as const,
  },
  ...
  company: {
    ...
    location: (id?: string) =>
      id
        ? ([...queryKeys.company.all, "location", id] as const)
        : ([...queryKeys.company.all, "location"] as const),
  },
 ...
 */
export const invalidateQueries = (queryClient: any, queryKey: readonly unknown[]) => {
 ...
 */
export const resetQueries = (queryClient: any, queryKey: readonly unknown[]) => {
