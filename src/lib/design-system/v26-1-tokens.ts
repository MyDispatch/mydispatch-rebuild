...
export const GRADIENTS_V26_1 = {
  // Hero Background
  hero_primary: 'linear-gradient(135deg, hsl(225, 31%, 28%) 0%, hsl(225, 31%, 35%) 50%, hsl(225, 31%, 42%) 100%)',
...
export const MOTION_V26_1 = {
  ...
  transition_footer: 'left 300ms cubic-bezier(0.4, 0, 0.2, 1), width 300ms cubic-bezier(0.4, 0, 0.2, 1)',
...
export const ELEVATION_V26_1 = {
  ...
  dashboard_preview: '0 0 60px rgba(234, 222, 189, 0.19), 0 25px 80px rgba(50, 61, 94, 0.5), 0 40px 120px rgba(0,0,0,0.4)',
