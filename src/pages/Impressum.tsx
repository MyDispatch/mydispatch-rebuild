  ...
  return (
    <MarketingLayout currentPage="legal">
      ...
      <V28HeroPremium
        ...
        visual={<PremiumDashboardContent pageType="impressum" />}
      />
          ...
          <V28MarketingCard>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="font-sans text-sm text-slate-600">
                  <strong>Bürozeiten:</strong> Mo-Fr: 09:00 - 17:00 Uhr
                </p>
                <p className="font-sans text-sm text-slate-600">
                  <strong>24/7 Support:</strong> E-Mail-Support rund um die Uhr
                </p>
                <p className="font-sans text-sm text-slate-600">
                  <strong>Reaktionszeit:</strong> &lt; 24h
                </p>
              </div>

              <div className="bg-slate-100 p-4 rounded-lg">
                <p className="font-sans text-sm font-semibold text-slate-900 mb-2">
                  Hinweis zur Geschäftstätigkeit:
                </p>
                <p className="font-sans text-sm text-slate-600">
                  Kleinunternehmer im Sinne von § 19 Abs. 1 UStG (Umsatzsteuergesetz)
                </p>
                <p className="font-sans text-sm text-slate-600">
                  Es wird keine Umsatzsteuer berechnet.
                </p>
                <p className="font-sans text-sm text-slate-600">
                  USt-IdNr.: Wird nach Erteilung angezeigt
                </p>
              </div>
            </div>
          </V28MarketingCard>
          ...
          <V28MarketingCard>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="font-sans text-sm text-slate-600">
                  Technologiepartner & Auftragsverarbeiter
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-sm font-semibold text-slate-900 mt-2">
                      Deutsche Anschrift:
                    </p>
                    <p className="font-sans text-sm text-slate-600">
                      Wallstrasse 9, 41334 Kaldenkirchen-Nettetal, Deutschland
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Mail className="h-4 w-4 text-slate-700" />
                    <a
                      href="mailto:support@nexify-automate.com"
                      className="font-sans text-sm text-slate-700 hover:text-slate-900 hover:underline transition-colors"
                    >
                  ...
                  <div className="flex items-center gap-2">
                    <Globe className="h-4 w-4 text-slate-700" />
                    <a
                      href="https://www.nexify-automate.com"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-sans text-sm text-slate-700 hover:text-slate-900 hover:underline transition-colors"
                    >
              ...
              <div>
                ...
                <p className="font-sans text-sm text-slate-600">
                  <strong>KvK-Nummer:</strong> 90483944
                </p>
                <p className="font-sans text-sm text-slate-600">
                  <strong>USt-ID:</strong> NL865786276B01
                </p>
              </div>

              <div className="bg-slate-100 p-4 rounded-lg">
                <p className="font-sans text-sm font-semibold text-slate-900 mb-2">
                  Rolle als Auftragsverarbeiter gemäß Art. 28 DSGVO:
                </p>
                <p className="font-sans text-sm text-slate-600 mb-2">
                  NeXify erbringt technische Dienstleistungen für MyDispatch (Hosting-Infrastruktur,
                  technischer Support, Systementwicklung, Wartung und Updates) ausschließlich als
                  Auftragsverarbeiter nach Weisung von MyDispatch. Die Datenverarbeitung erfolgt
                  DSGVO-konform auf Grundlage eines Auftragsverarbeitungsvertrags (AVV).
                </p>
                <p className="font-sans text-sm text-slate-600">
                  <strong>Leistungen:</strong> Cloud-Hosting (EU-Server), technischer 24/7-Support,
                  Software-Development, System-Wartung, Sicherheitsupdates, Performance-Optimierung
                </p>
              </div>
            </div>
          </V28MarketingCard>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="font-sans text-sm text-slate-600 mt-2">
                  ...
                  Gewähr übernehmen. Verpflichtungen zur Entfernung oder Sperrung der Nutzung von
              ...
              <div>
                <h3 className="font-sans text-lg font-semibold text-slate-900 mb-3">
                  Haftung für externe Links (§ 8 Abs. 1 TMG)
                </h3>
                <p className="font-sans text-sm text-slate-600">
              ...
              <div>
                ...
                <p className="font-sans text-sm text-slate-600">
                  ...
                  dies stets auf freiwilliger Basis und nach ausdrücklicher Einwilligung. Diese
                ...
                <p className="font-sans text-sm text-slate-600 mt-2">
                  ...
                  <a
                    href="/datenschutz"
                    className="font-sans text-slate-700 hover:text-slate-900 hover:underline transition-colors"
                  >
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="font-sans text-sm text-slate-600 mb-3">
                  ...
                  bereit, die Sie unter folgendem Link erreichen:
                </p>
                <a
              ...
              <div>
                <h3 className="font-sans text-lg font-semibold text-slate-900 mb-3">
                  Verbraucherschlichtung gemäß § 36 VSBG
                </h3>
                <p className="font-sans text-sm text-slate-600">
              ...
              <div className="bg-slate-100 p-4 rounded-lg">
                ...
                <p className="font-sans text-sm text-slate-600">
                  Bei Fragen oder Beschwerden wenden Sie sich bitte zunächst direkt an unseren
                  Kundensupport. Wir sind stets bemüht, eine einvernehmliche Lösung zu finden.
                </p>
              </div>
            </div>
          </V28MarketingCard>
