    ...
    <MarketingLayout currentPage="legal">
      ...
      <V28MarketingSection background="canvas">
        <div className="space-y-8">
          {/* RideHub Solutions Card - Updated 2025-11-22 */}
          <V28MarketingCard>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="font-sans text-lg font-semibold text-slate-900 mb-3">Unternehmen</h3>
                <p className="font-sans text-sm text-slate-600 mb-2"><strong>Inhaber:</strong> Ibrahim SIMSEK</p>
                <div className="flex items-start gap-2 mt-3">
                  <MapPin className="h-4 w-4 text-slate-700 mt-0.5" />
                  <div>
                    <p className="font-sans text-sm font-semibold text-slate-900 mb-1">Anschrift:</p>
              ...
              <div>
                <h3 className="font-sans text-lg font-semibold text-slate-900 mb-3">Kontakt</h3>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Phone className="h-4 w-4 text-slate-700" />
                    <span className="font-sans text-sm text-slate-600">Telefon:</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-sans text-sm text-slate-600">E-Mail:</span>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-sans text-sm text-slate-600">Website:</span>
              ...
              <div>
                ...
                <p className="font-sans text-sm text-slate-600"><strong>Mo-Fr:</strong> 09:00-17:00 Uhr</p>
                <p className="font-sans text-sm text-slate-600 mt-2 text-muted-foreground">E-Mail-Support auch außerhalb der Geschäftszeiten (Reaktionszeit: &lt; 24h)</p>
              </div>

              <div className="bg-slate-100 p-4 rounded-lg">
                <p className="font-sans text-sm font-semibold text-slate-900 mb-2">Verantwortlich für den Inhalt gemäß § 55 Abs. 2 RStV:</p>
                <p className="font-sans text-sm text-slate-600">Ibrahim SIMSEK, Ensbachmühle 4, D-94571 Schaufling</p>
              </div>
            </div>
          </V28MarketingCard>
