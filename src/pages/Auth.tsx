...
const TARIFFS = [
  ...
  },
  {
    ...
    features: BUSINESS_TARIFF.features
      .filter((f) => f.included)
      .slice(0, 6)
      .map((f) => f.name),
...
const entrepreneurSignupSchema = z
  .object({
    ...
    try {
      ...
      if (error) {
        ...
        if (error.message?.includes("Invalid login credentials")) {
          errorMessage =
            "E-Mail-Adresse oder Passwort ist falsch. Bitte prüfen Sie Ihre Eingaben oder setzen Sie Ihr Passwort zurück.";
      ...
      toast({
        ...
        description:
          "Für diesen Account existiert kein Profil. Bitte kontaktiere den Support oder erstelle ein neues Profil.",
        variant: "destructive",
      });
    ...
    try {
      ...
      const { data: company, error: companyError } = await supabase
        ...
        .insert({
          ...
          company_slug: signupData.companyName
            .toLowerCase()
            .replace(/[^a-z0-9]+/g, "-")
            .replace(/^-|-$/g, ""),
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsList className="grid w-full grid-cols-3 mb-6 sm:mb-8 bg-slate-100 border-slate-200 gap-0 z-40 relative">
                <TabsTrigger
                  ...
                  style={
                    activeTab === "login" && tenantCompany?.primary_color
                      ? {
                ...
                <TabsTrigger
                  ...
                  className="min-h-[52px] text-sm sm:text-base px-3 sm:px-4 py-3 data-[state=active]:bg-slate-700 data-[state=active]:text-white data-[state=inactive]:hover:bg-slate-200"
                  style={
                    activeTab === "signup" && tenantCompany?.primary_color
                      ? {
                          backgroundColor: tenantCompany.primary_color,
                        }
                      : undefined
                ...
                <TabsTrigger
                  ...
                  style={
                    activeTab === "reset" && tenantCompany?.primary_color
                      ? {
                          backgroundColor: tenantCompany.primary_color,
                        }
                      : undefined
                  ...
                  <form onSubmit={handleSignup} className="space-y-6 sm:space-y-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 py-3">
                        ...
                        >
                          Jährlich
                          <span className="ml-1 text-xs text-slate-600 font-semibold">
                            (20% Rabatt)
                          </span>
                        </span>
                      </div>
                          ...
                          >
                            <Checkbox
                              ...
                              onCheckedChange={(checked) =>
                                setFleetAddonEnabled(checked as boolean)
                              }
                              className="w-6 h-6"
                            />
                          </label>
                          ...
                          <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 p-4 sm:p-6">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start gap-2 mb-2">
                                ...
                                <V28Badge variant="primary" className="shrink-0">
                                  Empfohlen
                                </V28Badge>
                              </div>
                    ...
                    <div className="p-4 rounded-lg bg-slate-100 border border-slate-200">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm space-y-2 text-slate-600">
                          ...
                          <p>
                            <strong>DSGVO:</strong> Ihre Daten werden verschlüsselt auf deutschen
                            Servern gespeichert und ausschließlich zur Vertragserfüllung verwendet.
                          </p>
                          <p>
                            <strong>PBefG § 51:</strong> Gemäß Personenbeförderungsgesetz sind wir
                            zur Speicherung von Betreiberdaten verpflichtet.
                          </p>
                        </div>
                      </div>
                    </div>
