...
export default function FAQ() {
  ...
  const allQuestions = useMemo(() => faqCategories.flatMap((cat) => cat.questions), []);
    ...
    <MarketingLayout currentPage="faq">
      ...
      <V28MarketingSection background="canvas">
            ...
            {filteredCategories.map((category) => (
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="font-sans text-xl sm:text-2xl font-semibold text-slate-900">
                    {category.category}
                  </h3>
        ...
        <V28MarketingCard className="mt-12 bg-slate-600 text-white text-center">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">Frage nicht gefunden?</h3>
