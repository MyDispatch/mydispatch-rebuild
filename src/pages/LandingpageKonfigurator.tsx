  ...
  useEffect(() => {
    if (company) {
      setConfig({
        ...
        business_hours: (typeof company.business_hours === 'object' && company.business_hours !== null 
      ...
      <FeatureGate requiredTariff="Business" feature="Landingpage-Konfigurator">
        ...
        <Card className="p-6 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => setConfig({ ...config, landingpage_enabled: checked })}
              />
            </div>
          </div>
          ...
          <Tabs defaultValue="general" className="w-full">
            <TabsList>
              <TabsTrigger value="general" className="min-h-[44px]">Allgemein</TabsTrigger>
              <TabsTrigger value="widget" className="min-h-[44px]">Widget</TabsTrigger>
              <TabsTrigger value="hours" className="min-h-[44px]">Zeiten</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="general" className="space-y-4">
              ...
              <div className="space-y-2 p-4 border rounded-lg bg-muted/30">
                <div className="flex items-center justify-between">
                  <Label htmlFor="company_slug" className="text-base font-semibold">Landing-Domain (URL-Slug)</Label>
                  {slugSaving && <span className="text-xs text-muted-foreground">Speichert...</span>}
                </div>
                <Input
                  id="company_slug"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    {config.logo_url && (
                      <img src={config.logo_url} alt="Logo" className="h-12 w-auto object-contain border rounded p-2" />
                    )}
                    <label
                      htmlFor="logo-upload"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => setConfig({ ...config, landingpage_hero_text: e.target.value })}
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => setConfig({ ...config, landingpage_description: e.target.value })}
            ...
            <TabsContent value="widget" className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  <Label htmlFor="widget-enabled" className="text-base">Widget aktivieren</Label>
                  <p className="text-sm text-muted-foreground mt-1">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setConfig({ ...config, widget_show_phone: checked })}
                    disabled={!hasBusinessFeatures}
                  />
                </div>
              </div>
          ...
          <div className="flex gap-2">
            <V28Button onClick={handleSave} disabled={loading} className="flex-1" variant="primary">
              <Save className="h-4 w-4 mr-2" />
              {loading ? 'Wird gespeichert...' : 'Speichern'}
            </V28Button>
            <a
              href={company?.company_slug ? `/${company.company_slug}` : `/unternehmer?id=${company?.id}`}
              target="_blank"
              rel="noopener noreferrer"
        ...
        <Card className="p-6">
          ...
          <div className="border rounded-lg overflow-hidden bg-background" style={{ minHeight: '600px' }}>
            <iframe
              src={company?.company_slug ? `/${company.company_slug}?preview=true` : `/unternehmer?id=${company?.id}&preview=true`}
