...
export default function Angebote() {
  ...
  const quoteKPIs = useMemo(
    ...
    [pendingQuotes, acceptedQuotes, filteredQuotes, quotes, declinedQuotes]
  );
  ...
  return (
    <>
              ...
              <TableBody>
                {filteredQuotes.map((quote) => (
                  ...
                  >
                    ...
                    <TableCell className="max-w-[200px] truncate">{quote.pickup_address}</TableCell>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          quote.offer_status === "accepted"
                            ? "default"
                            : quote.offer_status === "declined"
                              ? "destructive"
                              : "secondary"
                        }
                      >
      ...
      {!isMobile && (
        <aside className="fixed right-0 top-16 bottom-0 w-80 bg-white border-l border-slate-200 shadow-lg z-20 overflow-y-auto hidden md:block">
          {/* Schnellzugriff */}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1 flex items-center gap-2">
                <Badge
                  variant={
                    selectedQuote.offer_status === "accepted"
                      ? "default"
                      : selectedQuote.offer_status === "declined"
                        ? "destructive"
                        : "secondary"
                  }
                >
