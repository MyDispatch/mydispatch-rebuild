...
export default function EnterpriseDetail() {
  ...
  return (
    <MarketingLayout currentPage="pricing">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-8">
              Alle Business-Features plus White-Label-Branding, individuelle Anpassungen,
              dedizierter Account Manager und 24/7 Premium-Support. Perfekt für große Flotten ab 15
              Fahrzeugen.
            </p>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-2xl border-2 border-slate-700 shadow-2xl text-white">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-2xl font-bold">{ENTERPRISE_TARIFF.name}</h3>
            </div>
      ...
      >
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <V28MarketingCard>
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3">White-Label Landingpages</h3>
          ...
          <V28MarketingCard>
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-3">Custom Integrationen</h3>
            <p className="text-slate-600">
          ...
          <V28MarketingCard>
            <V28IconBox icon={Shield} />
            <h3 className="text-xl font-semibold text-slate-900 mb-3">SLA-Garantie</h3>
            <p className="text-slate-600">
          ...
          <V28MarketingCard>
            <V28IconBox icon={Cpu} />
            <h3 className="text-xl font-semibold text-slate-900 mb-3">24/7 Premium-Support</h3>
            <p className="text-slate-600">
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-600 mb-6">
            ... und alle Business-Features: Partner-Management, Kunden-Portal, Statistiken,
            API-Zugang, Team-Chat, Workflow-Automatisierung, GPS-Tracking, Auftragsverwaltung und
            vieles mehr
          </p>
        </div>
      </V28MarketingSection>
      ...
      >
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <div className="p-8 bg-slate-50 rounded-2xl border border-slate-200">
            ...
            <p className="text-slate-600">
              Sie betreiben eine große Fahrzeugflotte und benötigen individuelle Anpassungen,
              White-Label-Branding und dedizierten Support.
            </p>
          </div>
          <div className="p-8 bg-slate-50 rounded-2xl border border-slate-200">
            <div className="text-4xl mb-4">🏢</div>
            ...
            <p className="text-slate-600">
              Sie verwalten mehrere Standorte oder Tochterunternehmen und benötigen eine zentrale
              Plattform mit individuellen Integrationen.
            </p>
          </div>
        </div>
      </V28MarketingSection>
      ...
      <V28MarketingSection background="white" title="Häufige Fragen zum Enterprise-Tarif">
