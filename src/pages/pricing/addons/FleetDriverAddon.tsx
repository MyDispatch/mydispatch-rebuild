...
export default function FleetDriverAddon() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-b from-slate-50 to-white py-16 sm:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-6">{addOn.name}</h1>

            <p className="text-xl text-slate-600 mb-8">{addOn.description}</p>
      ...
      {/* Preis-Rechner */}
      <V28MarketingSection title="Preisrechner" description="Berechnen Sie Ihre monatlichen Kosten">
      ...
      {/* Was ist enthalten */}
      <V28MarketingSection title="Was ist enthalten?" description="Alle Features im Überblick">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <V28MarketingCard className="bg-slate-50 border-slate-200">
            <h3 className="text-lg font-semibold text-slate-900 mb-3">
              Starter-Kunden mit wachsender Flotte
            </h3>
            <p className="text-slate-600">
              Sie starten mit dem Starter-Tarif (10 Fahrzeuge), benötigen aber gelegentlich mehr
              Kapazität? Das Add-On ermöglicht Ihnen flexibel zu skalieren ohne zum Business-Tarif
              wechseln zu müssen.
            </p>
          </V28MarketingCard>
          ...
          <V28MarketingCard className="bg-slate-50 border-slate-200">
            ...
            <p className="text-slate-600">
              Perfekt für Unternehmen mit saisonalen Auslastungsspitzen. Buchen Sie das Add-On nur
              wenn Sie es benötigen - jederzeit kündbar, keine Mindestlaufzeit.
            </p>
          </V28MarketingCard>
        </div>
      </V28MarketingSection>
      ...
      >
        <Card className="max-w-3xl mx-auto p-8 bg-slate-50 border-slate-200">
          <div className="space-y-4 text-slate-700">
            <p className="text-lg">
              <strong>Starter + Add-On:</strong> {totalMonthly}€ / Monat (für begrenzte zusätzliche
              Einheiten)
            </p>
            <p className="text-lg">
              <strong>Business-Tarif:</strong> 99€ / Monat (keine Begrenzung bei Fahrzeugen &
              Fahrern + Premium-Features)
            </p>

            <div className="border-t border-slate-300 pt-4 mt-6">
              <p className="text-slate-600">
                <strong>Empfehlung:</strong> Ab ca. 15-20 Fahrzeugen lohnt sich der Wechsel zum
                Business-Tarif, da Sie dann zusätzlich Premium-Support, API-Zugang und erweiterte
                Analysen erhalten.
              </p>
            </div>
          </div>
      ...
      <section className="bg-slate-900 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Bereit zu skalieren?</h2>
