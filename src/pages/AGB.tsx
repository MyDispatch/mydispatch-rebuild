  ...
  return (
    <MarketingLayout currentPage="legal">
      ...
      <V28HeroPremium
        ...
        visual={
          <PremiumDashboardContent pageType="agb" />
        }
      />
          ...
          <div className="space-y-8 md:space-y-12">
            ...
            <section>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="font-sans text-slate-600">Basisdisposition für bis zu 3 aktive Fahrer/Fahrzeuge</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                      <span className="font-sans text-slate-600">Angebots- und Rechnungserstellung</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                ...
                <div>
                  <h3 className="font-sans text-xl font-semibold text-slate-900 mb-3">Business-Tarif (99€/Monat)</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                      <span className="font-sans text-slate-600">Keine Begrenzung bei Fahrern/Fahrzeugen</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                      <span className="font-sans text-slate-600">Live-Verkehrsinformationen & Wetterdaten</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                      <span className="font-sans text-slate-600">Erweiterte Statistiken & Reports</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                      <span className="font-sans text-slate-600">Landingpage mit Buchungs-Widget</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                      <span className="font-sans text-slate-600">Priority-Support (E-Mail + Chat)</span>
                    </li>
                  </ul>
                </div>

                <div>
                  <h3 className="font-sans text-xl font-semibold text-slate-900 mb-3">Enterprise-Tarif (Auf Anfrage)</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                      <span className="font-sans text-slate-600">White-Labeling (eigenes Branding)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
            ...
            <section>
              ...
              <p className="font-sans text-base md:text-lg text-slate-600 leading-relaxed mb-3">
                <strong className="font-sans text-slate-900">Beförderungspflicht:</strong> Gem. § 22 PBefG besteht grundsätzlich eine Beförderungspflicht.<br />
                <strong className="font-sans text-slate-900">Entgelte:</strong> Preise sind gem. § 51 PBefG festgelegt und transparent dargestellt.<br />
                <strong className="font-sans text-slate-900">Stornierung:</strong> Kostenfreie Stornierung bis 24 Stunden vor Abholung. Danach: Stornogebühr 50% des Fahrpreises.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="font-sans text-base md:text-lg text-slate-600 leading-relaxed mb-3">Der Kunde verpflichtet sich:</p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600">Zugangsdaten vertraulich zu behandeln und nicht an Dritte weiterzugeben</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600">Die Software ausschließlich rechtmäßig und gemäß ihrer Zweckbestimmung zu nutzen</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600">Regelmäßige Datensicherungen durchzuführen</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600">Störungen und Sicherheitsvorfälle unverzüglich zu melden</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600">Keine Reverse-Engineering-Maßnahmen durchzuführen</span>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="font-sans text-base md:text-lg text-slate-600 leading-relaxed mb-3">
                <strong className="font-sans text-slate-900">Stornoregelung (Branchenüblich für Taxi- und Mietwagenfahrten):</strong>
              </p>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600"><strong className="font-sans text-slate-900">Mehr als 24 Stunden vor Abholung:</strong> Kostenfreie Stornierung</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600"><strong className="font-sans text-slate-900">24-12 Stunden vor Abholung:</strong> 50% des Fahrpreises als Stornogebühr</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600"><strong className="font-sans text-slate-900">Weniger als 12 Stunden vor Abholung:</strong> 100% des Fahrpreises als Stornogebühr</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 h-1.5 w-1.5 rounded-full bg-slate-700 shrink-0"></span>
                  <span className="font-sans text-slate-600"><strong className="font-sans text-slate-900">No-Show (Kunde erscheint nicht):</strong> 100% des Fahrpreises als Entschädigung</span>
                </li>
              </ul>
            ...
            <div className="bg-slate-50 rounded-xl p-6 mt-12 border border-slate-200">
              <p className="font-sans text-sm text-slate-600">
                <strong className="font-sans text-slate-900">Stand:</strong> {new Date().toLocaleDateString('de-DE', { day: '2-digit', month: '2-digit', year: 'numeric' })}
              </p>
              <p className="font-sans text-sm text-slate-600 mt-2">
                <strong className="font-sans text-slate-900">Anbieter:</strong> Ibrahim SIMSEK<br />
                Ensbachmühle 4<br />
