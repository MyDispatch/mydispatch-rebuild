          ...
          <div className="space-y-8 md:space-y-12">
            ...
            <section>
              ...
              <p className="font-sans text-base md:text-lg text-slate-600 leading-relaxed">
                Diese Nutzungsbedingungen regeln die Nutzung der MyDispatch-Plattform, einer
                Software-as-a-Service (SaaS) Lösung für Taxi- und Mietwagenunternehmen, betrieben
                von RideHub Solutions, Inhaber Ibrahim SIMSEK, Ensbachmühle 4, D-94571 Schaufling,
                Deutschland.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="font-sans text-slate-600 leading-relaxed mb-3">
                MyDispatch stellt eine cloudbasierte Dispositionssoftware bereit, die folgende
                Funktionen umfasst:
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    Die Nutzung von MyDispatch erfordert eine Registrierung. Bei der Registrierung
                    sind vollständige und wahrheitsgemäße Angaben zu machen. Der Nutzer ist
                    verpflichtet, seine Daten aktuell zu halten.
                  </p>
                </div>
                <div>
                  <h3 className="font-sans text-lg font-semibold text-slate-900 mb-2">
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    ...
                    Zugriff Dritter zu schützen. Bei Verdacht auf Missbrauch ist MyDispatch
                    unverzüglich zu informieren.
                  </p>
                </div>
                <div>
                  <h3 className="font-sans text-lg font-semibold text-slate-900 mb-2">
                    3.3 Kontoberechtigung
                  </h3>
                  <p className="font-sans text-slate-600 leading-relaxed">
                    Ein Nutzerkonto darf nur von registrierten, geschäftsfähigen Personen oder
                    vertretungsberechtigten Personen eines Unternehmens erstellt werden.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    MyDispatch gewährt dem Nutzer ein nicht ausschließliches, nicht übertragbares
                    Recht zur Nutzung der Software im Rahmen des gewählten Tarifs.
                  </p>
                </div>
                <div>
                  <h3 className="font-sans text-lg font-semibold text-slate-900 mb-2">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    MyDispatch strebt eine Verfügbarkeit von 99% pro Kalenderjahr an.
                ...
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    Support steht per E-Mail (info@my-dispatch.de) und Telefon (+49 170 8004423)
                    während der Geschäftszeiten (Mo-Fr 09:00-18:00 Uhr) zur Verfügung.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-6 space-y-2 font-sans text-slate-600">
                    <li>
                      Starter: 39 €/Monat oder 374,40 €/Jahr (Bis zu 3 Fahrer/Fahrzeuge,
                      Basisdisposition, Kunden-/Fahrerverwaltung, Auftragsverwaltung, Angebote &
                      Rechnungen, Info-Landingpage)
                    </li>
                    <li>
                      Business: 99 €/Monat oder 950,40 €/Jahr (Keine Begrenzung bei
                      Fahrern/Fahrzeugen, alle Starter-Features, Partner-Management, Live-Traffic &
                      Wetter, Statistiken, Kunden-Portal, Buchungswidget, AI-Chatbot, API-Zugang)
                    </li>
                    <li>Enterprise: Individuelle Preisgestaltung</li>
                    <li>
                      Fleet & Driver Erweiterung: 9 €/Monat oder 86,40 €/Jahr pro zusätzlichem
                ...
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    Die Zahlung erfolgt monatlich im Voraus per Lastschrift oder Kreditkarte über
                    Stripe. Alle Preise verstehen sich zuzüglich der gesetzlichen Mehrwertsteuer.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    Der Vertrag wird auf unbestimmte Zeit geschlossen und verlängert sich
                ...
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    ...
                    kündigen. Die Kündigung bedarf der Textform (E-Mail genügt).
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    MyDispatch haftet unbeschränkt bei Vorsatz und grober Fahrlässigkeit, für die
                ...
                <div>
                  ...
                  <p className="font-sans text-slate-600 leading-relaxed">
                    Bei leichter Fahrlässigkeit haftet MyDispatch nur bei Verletzung wesentlicher
            ...
            <section>
              ...
              <p className="font-sans text-slate-600 leading-relaxed">
                MyDispatch gewährleistet, dass die Software im Wesentlichen gemäß der
                Leistungsbeschreibung funktioniert. Bei Mängeln wird MyDispatch diese innerhalb
            ...
            <section className="bg-slate-50 p-6 rounded-xl border border-slate-200 text-center">
              <p className="font-sans text-sm text-slate-600">
                <strong className="text-slate-900">RideHub Solutions</strong>
                <br />
