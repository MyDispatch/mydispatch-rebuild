  ...
  const features = [
    {
      icon: Clock,
      title: "24/7 Support",
      description: "Rund um die Uhr erreichbar – auch nachts und am Wochenende",
    },
    {
      icon: Phone,
      title: "Hotline-Priorität",
      description: "Keine Warteschlangen – direkte Durchstellung",
    },
    {
      icon: Users,
      title: "Account Manager",
      description: "Dedizierter Ansprechpartner für Ihr Unternehmen",
    },
    {
      icon: Headphones,
      title: "Vor-Ort-Schulungen",
      description: "Persönliche Schulungen in Ihrem Unternehmen",
    },
  ];
