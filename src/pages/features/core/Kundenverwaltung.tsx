  ...
  return (
    <MarketingLayout currentPage="features">
      <SEOHead
        ...
        description="Verwalten Sie alle Kundendaten zentral mit Fahrhistorie, VIP-Markierungen und Umsatz-Tracking."
        canonical="/features/core/kundenverwaltung"
      />
      ...
      <V28HeroPremium
        ...
        badge={{ text: "Core-Feature", icon: UserCheck }}
