...
import { 
  ...
  Shield, FileText, Star, Repeat, Euro, Route, Target
} from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 md:py-16">
        <div className="max-w-5xl mx-auto text-center space-y-4 sm:space-y-6 md:space-y-8">
          ...
          <div className="space-y-2 sm:space-y-3 md:space-y-4">
            ...
            <Body size="large" className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            <EnhancedCard.Content className="py-6">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 text-left">
                  ...
                  <Body className="text-muted-foreground mb-2">
                    {FIRST_RELEASE.description}
                  </Body>
