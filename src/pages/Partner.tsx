...
export default function Partner() {
  ...
  const bulkSelection = useBulkSelection<Partner>();
  ...
  ] as [any, any, any], [partners, pendingRequests]);

  const partnerQuickActions: [any, any] = useMemo(() => [
    QuickActionsGenerator.create('Neuer Partner', Plus, () => setShowForm(true)),
    QuickActionsGenerator.custom({ label: 'Partner-Anfrage', icon: Send, onClick: () => setShowRequestDialog(true) }),
  ], []);
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {formatCurrency(selectedPartner.provision_amount)}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {format(new Date(selectedPartner.updated_at), 'dd.MM.yyyy HH:mm', { locale: de })} Uhr
                  </p>
                </div>
              </div>
            </div>
    ...
    <>
      ...
      >
        ...
        <UniversalExportBar
          ...
          filename={`partner-${new Date().toISOString().split('T')[0]}`}
          showPdf={true}
          showExcel={true}
          showCsv={true}
        />
