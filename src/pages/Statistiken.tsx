/* ==================================================================================
   KRITISCHER HINWEIS: Statistiken - LIVE-DATEN V18.3 Sprint 35!
   ==================================================================================
  ...
  return (
    <>
      ...
      <FeatureGate requiredTariff="Business" feature="Erweiterte Statistiken">
        ...
        <UtilizationHeatmap
          onClick={(day, hour) => {
            // Navigate zu Aufträge mit Filter nach Wochentag/Stunde
            ...
            <div className="space-y-3">
              <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs font-medium text-slate-600">Aufträge (heute)</span>
                  <FileText className="h-4 w-4 text-slate-400" />
                </div>
                <p className="text-2xl font-bold text-slate-900">{liveStats?.bookings_today || 0}</p>
                <p className="text-xs text-slate-500 mt-1">Heute aktiv</p>
              </div>

              <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs font-medium text-green-600">Umsatz (heute)</span>
                  <Euro className="h-4 w-4 text-green-400" />
                </div>
                <p className="text-lg font-bold text-green-700">
                  {formatCurrency(liveStats?.revenue_today || 0)}
                </p>
                <p className="text-xs text-green-500 mt-1">Heute</p>
              </div>

              <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-center justify-between mb-1">
                  <span className="text-xs font-medium text-blue-600">Auslastung</span>
                  <Car className="h-4 w-4 text-blue-400" />
                </div>
                <p className="text-2xl font-bold text-blue-700">{utilization}%</p>
                <p className="text-xs text-blue-500 mt-1">Durchschnitt</p>
              </div>
            </div>
          </div>
        </div>
