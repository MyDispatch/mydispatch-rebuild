    ...
    <>
      ...
      <div className="container max-w-4xl mx-auto py-8 px-4 space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Datenschutz & Privatsphäre</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Laden Sie alle Ihre gespeicherten Daten herunter</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="bg-muted/50 p-4 rounded-lg space-y-2">
              <p className="text-sm text-muted-foreground">Der Export enthält:</p>
          ...
          <CardContent className="space-y-4">
            {deletionStatus === "pending" ? (
              ...
              <>
                ...
                <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                  <p className="text-sm text-muted-foreground">Folgende Daten werden gelöscht:</p>
                  <ul className="text-sm space-y-1 text-muted-foreground">
                ...
                {!showDeletionConfirm ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <V28Button variant="destructive" onClick={handleRequestDeletion}>
                        Ja, Konto löschen
                      </V28Button>
                      <V28Button variant="secondary" onClick={() => setShowDeletionConfirm(false)}>
                        Abbrechen
                      </V28Button>
                    </div>
                  </div>
          ...
          <CardContent className="p-6">
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Recht auf Auskunft (Art. 15 DSGVO):</strong> Sie können eine Kopie Ihrer
                  Daten anfordern
                </span>
              </li>
              <li className="flex items-start gap-2">
