...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center font-sans pointer-events-none [&:hover]:!bg-transparent">
      ...
      <h3 className="text-lg font-semibold text-foreground mb-2 text-center [&:hover]:!bg-transparent">
        {title}
      </h3>
      ...
      {!isSearchResult && actionLabel && onAction && (
        <V28Button onClick={onAction} variant="primary" size="md" className="rounded-full">
