            ...
            <div className="space-y-6 text-foreground">
              <section>
                ...
                <p className="text-sm text-muted-foreground">
                  Bitte kontaktieren Sie uns über die auf der Webseite angegebenen Kontaktdaten für
                  vollständige Impressumsinformationen.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-sm text-muted-foreground">
                  Geschäftsführung bzw. vertretungsberechtigte Person(en) gemäß
            ...
            <div className="space-y-6 text-foreground">
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  kann es sich z.B. um Daten handeln, die Sie in ein Kontaktformular oder bei einer
                  Buchungsanfrage eingeben. Andere Daten werden automatisch oder nach Ihrer
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  werden, sowie zur Bearbeitung von Buchungsanfragen und Kundenanliegen.
                </p>
              ...
              <section>
                ...
                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>Anbieter:</strong> Google Cloud Platform, Cloudflare (CDN)
                  </p>
                  <p className="text-sm mb-2">
                    <strong>Serverstandort:</strong> Deutschland (Frankfurt), EU-Datacenter
                  </p>
                  <p className="text-sm mb-2">
                    <strong>Zweck:</strong> Hosting der MyDispatch-Anwendung, Datenbank, API-Gateway
                  </p>
                  <p className="text-sm mb-2">
                    <strong>Rechtsgrundlage:</strong> Art. 6 Abs. 1 lit. b DSGVO
                    (Vertragserfüllung), Art. 28 DSGVO (Auftragsverarbeitungsvertrag)
                  </p>
                  <p className="text-sm mb-2">
                    <strong>Datenschutz:</strong> Google Cloud & Cloudflare sind DSGVO-zertifiziert.
                    Alle Daten verbleiben in der EU.
                  </p>
                  <p className="text-sm">
                    <strong>AVV:</strong> Auftragsverarbeitungsverträge mit Google Cloud &
                    Cloudflare liegen vor.
                  </p>
                </div>

                <p className="text-sm text-muted-foreground">
                  Die Verwendung dieser Dienstleister erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f
              ...
              <section>
                ...
                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>Anbieter & Modelle:</strong> MyDispatch AI (Google Gemini 2.5 Flash,
                    Anthropic Claude Sonnet 4)
                  </p>
                  <p className="text-sm mb-2">
                    <strong>Hosting:</strong> Google Cloud Platform (EU-Datacenter, DSGVO-konform)
                  </p>
                  <p className="text-sm mb-2">
                    <strong>Transparenz:</strong> AI Act Art. 52 - vollständige Transparenz über
                    KI-Nutzung
                  </p>
                  <p className="text-sm">
                    <strong>Zweck:</strong> Support-Anfragen, Dispositions-Optimierung,
                    Routenplanung, Fahrtenanalyse
                  </p>
                </div>

                <p className="text-sm text-muted-foreground mb-3">
                  Auf dieser Website wird ein KI-gestützter Chatbot eingesetzt, um Ihre Anfragen zu
                  beantworten und Support zu leisten. Die Verarbeitung erfolgt auf Grundlage von
                  Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an effizienter
                  Kundenbetreuung).
                </p>

                <p className="text-sm text-muted-foreground">
                  <strong>Hinweis gemäß AI Act (Art. 52):</strong> Sie kommunizieren mit einem
                  KI-System. Die eingegebenen Daten werden zur Verbesserung der Antwortqualität
                  verarbeitet, aber nicht für das Training der KI-Modelle verwendet.
                  Personenbezogene Daten werden verschlüsselt übertragen und nicht an Dritte
                  weitergegeben.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  Impressum genannte Betreiber. Verantwortliche Stelle ist die natürliche oder
                  juristische Person, die allein oder gemeinsam mit anderen über die Zwecke und
                  Mittel der Verarbeitung von personenbezogenen Daten (z.B. Namen, E-Mail-Adressen
                  o. Ä.) entscheidet.
                </p>
              ...
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Wenn Sie uns per Kontaktformular oder Buchungswidget Anfragen zukommen lassen,
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
                  ...
                  <li>
                    <strong>Recht auf Einschränkung (Art. 18 DSGVO):</strong> Sie haben das Recht,
                    die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen.
                  </li>
                  <li>
                    <strong>Recht auf Widerspruch (Art. 21 DSGVO):</strong> Sie haben das Recht, aus
              ...
              <p className="text-xs text-muted-foreground mt-8 pt-4 border-t">
                Quelle: eRecht24 | MyDispatch DSGVO-Konforme Datenschutzerklärung
                <br />
                Stand: {currentDate}
              </p>
            </div>
        ...
        return {
          ...
          content: (
            <div className="space-y-6 text-foreground">
              ...
              <p className="text-xs text-muted-foreground mt-8 pt-4 border-t">
                © {currentYear} {companyName} | Allgemeine Geschäftsbedingungen für Taxi- und
                Mietwagenverkehr
                <br />
                Stand: {currentDate}
              </p>
          ...
          content: (
            <div className="space-y-6 text-foreground">
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Diese Website und das MyDispatch-System nutzen Künstliche Intelligenz (KI) zur
                  Optimierung von Prozessen und zur Verbesserung der Nutzerfahrung. Gemäß der
                  EU-Verordnung über Künstliche Intelligenz (AI Act, Art. 52) informieren wir Sie
                  transparent über den Einsatz von KI-Systemen.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>1. Support-Chatbot & KI-Assistent</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                ...
                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>2. Dispositionsoptimierung</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    <strong>Menschliche Kontrolle:</strong> Disponenten können jederzeit manuell in
                    die KI-Vorschläge eingreifen und Zuweisungen ändern.
                  </p>
                </div>

                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>3. Preisberechnung & Kostenschätzung</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                ...
                <div className="bg-muted/30 p-4 rounded-lg">
                  <p className="text-sm mb-2">
                    <strong>4. Bildanalyse & Dokumentenerkennung</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                    <strong>Zweck:</strong> Automatische Erkennung von Führerscheinen,
                    Fahrzeugdokumenten, Rechnungen (OCR - Optical Character Recognition)
                  </p>
                  <p className="text-sm text-muted-foreground">
                    <strong>Datenschutz:</strong> Hochgeladene Dokumente werden nur temporär
                    verarbeitet und nach Extraktion der relevanten Informationen gelöscht.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm text-muted-foreground">
                  <li>
                    <strong>Recht auf Information:</strong> Sie haben jederzeit das Recht zu
                    erfahren, ob eine Entscheidung durch ein KI-System getroffen wurde.
                  </li>
                  <li>
                    <strong>Recht auf menschliche Intervention:</strong> Bei wichtigen
                    Entscheidungen können Sie die Überprüfung durch einen Menschen verlangen.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Erklärungsrecht:</strong> Sie können eine verständliche Erklärung
                    verlangen, wie eine KI-gestützte Entscheidung zustande gekommen ist.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  <strong>Training:</strong> Ihre Eingaben werden NICHT zum Training der KI-Modelle
                  verwendet. Die eingesetzten Modelle sind vortrainiert und werden extern gehostet.
                </p>
                <p className="text-sm text-muted-foreground mb-3">
                  <strong>Datenspeicherung:</strong> Chat-Verläufe werden nur für die Dauer der
                  Session gespeichert und nach 24 Stunden automatisch gelöscht, sofern Sie keine
                  Speicherung wünschen.
                </p>
                <p className="text-sm text-muted-foreground mb-3">
              ...
              <section>
                <h3 className="font-bold text-lg mb-3 mt-6">
                  Qualitätssicherung & Fehlerkorrektur
                </h3>
                <p className="text-sm text-muted-foreground mb-3">
                ...
                <p className="text-sm text-muted-foreground">
                  <strong>Feedback:</strong> Bei fehlerhaften KI-Antworten oder unerwünschtem
                  Verhalten können Sie uns jederzeit kontaktieren: support@
                  {companyName.toLowerCase().replace(/\s+/g, "-")}.de
                </p>
              </section>
              ...
              <p className="text-xs text-muted-foreground mt-8 pt-4 border-t">
                © {currentYear} {companyName} | KI-Transparenzerklärung gemäß AI Act Art. 52
                <br />
                Stand: {currentDate}
              </p>
            </div>
            ...
            <div className="space-y-6 text-foreground">
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  Sie eine Website besuchen. Sie ermöglichen es, Ihre Präferenzen zu speichern, die
                  Website-Nutzung zu analysieren und Ihnen ein besseres Nutzererlebnis zu bieten.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>1. Notwendige Cookies (Technisch erforderlich)</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                    <strong>Zweck:</strong> Diese Cookies sind für die Grundfunktionen der Website
                    unerlässlich (z.B. Login-Session, Warenkorb, Sicherheit).
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                ...
                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>2. Funktionale Cookies</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                    <strong>Zweck:</strong> Speicherung Ihrer Einstellungen (Sprache, Währung, Dark
                    Mode, Sidebar-Präferenzen)
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                ...
                <div className="bg-muted/30 p-4 rounded-lg mb-3">
                  <p className="text-sm mb-2">
                    <strong>3. Analytische Cookies</strong>
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    <strong>Anbieter:</strong> Plausible Analytics (DSGVO-konform, keine
                    IP-Speicherung, EU-Hosting)
                  </p>
                  <p className="text-sm text-muted-foreground mb-2">
                ...
                <div className="bg-muted/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Es erfolgt kein Tracking durch Drittanbieter wie Google Ads, Facebook Pixel,
                    etc.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  Browser-Einstellungen ändern. Beachten Sie, dass das Deaktivieren bestimmter
              ...
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Zusätzlich zu Cookies verwenden wir LocalStorage und SessionStorage zur
                  Speicherung von Daten direkt in Ihrem Browser. Diese Daten werden NICHT an unsere
                  Server übertragen.
                </p>
                <p className="text-sm text-muted-foreground mb-2">
              ...
              <section>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Sollten Sie Fragen zu unserer Cookie-Nutzung haben oder Ihre Einwilligung
                  widerrufen möchten, kontaktieren Sie uns bitte:
                </p>
                <p className="text-sm text-muted-foreground mb-2">
                  <strong>E-Mail:</strong> datenschutz@
                  {companyName.toLowerCase().replace(/\s+/g, "-")}.de
                </p>
                <p className="text-sm text-muted-foreground">
                  <strong>Widerruf:</strong> Ihre Einwilligung können Sie jederzeit mit Wirkung für
                  die Zukunft widerrufen, indem Sie die Cookie-Einstellungen ändern oder alle
                  Cookies löschen.
                </p>
              </section>

              <p className="text-xs text-muted-foreground mt-8 pt-4 border-t">
                © {currentYear} {companyName} | Cookie-Policy gemäß DSGVO & ePrivacy-Richtlinie
                <br />
                Stand: {currentDate}
              </p>
            </div>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[85vh] overflow-hidden">
        <DialogHeader className="pb-4 border-b">
          <DialogTitle className="text-2xl sm:text-3xl font-bold text-foreground flex items-center gap-2">
