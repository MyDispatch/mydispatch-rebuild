  ...
  return (
    <div
      ...
      style={{
        ...
        border: highlighted ? "none" : `1px solid rgba(229, 231, 235, 0.3)`,
    ...
    >
        ...
        <div className="absolute -top-5 left-1/2 -translate-x-1/2 z-10">
          <div
            ...
            style={{
              ...
              boxShadow:
                "0 4px 16px rgba(91, 113, 184, 0.3), 0 8px 24px rgba(0, 0, 0, 0.15), inset 0 1px 2px rgba(255, 255, 255, 0.3)",
            }}
          >
            <span
      ...
      <div className={cn("relative pb-6 px-10", badge ? "pt-14" : "pt-10")}>
        ...
        <div className="mb-4">
          ...
          <p className="font-sans text-sm font-normal mt-1" style={{ color: "hsl(220, 9%, 46%)" }}>
            {priceLabel}
          </p>
        </div>
        ...
        <ul className="space-y-3.5 mb-8 flex-1">
          {displayedFeatures.map((feature) => (
            <li key={feature.id} className="flex items-start gap-3">
              ...
              <span className="text-base font-normal" style={{ color: "rgba(91, 113, 184, 0.8)" }}>
                {feature.name}
              </span>
            </li>
          ))}
