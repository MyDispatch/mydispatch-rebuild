  ...
  if (isMobile) {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 pt-14 pb-0 px-4 overflow-y-auto">{children}</main>
    ...
    <div className="min-h-screen flex bg-background overflow-x-hidden max-w-full">
        ...
        style={{
          marginLeft:
            window.location.pathname === "/dashboard"
              ? sidebarExpanded
                ? "560px"
                : "384px" // AppSidebar (240px/64px) + DashboardSidebar (320px)
              : sidebarExpanded
                ? "240px"
                : "64px", // Nur AppSidebar
          marginRight: (() => {
      ...
      >
        ...
        >
          ...
          <div className="min-h-full relative z-10">{children}</div>
        </main>
          ...
          <Sheet>
            ...
            <SheetContent side="bottom" className="h-[85vh] rounded-t-3xl">
              <SheetHeader className="mb-4">
                ...
                <SheetDescription>Häufig genutzte Aktionen und Systemstatus</SheetDescription>
              </SheetHeader>
              <UniversalQuickActionsPanel
                quickActions={quickActionsPanel.quickActions}
                recentActivities={quickActionsPanel.recentActivities}
