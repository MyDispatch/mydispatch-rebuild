  ...
  return (
    <aside
      ...
      style={{
        ...
        boxShadow: designTokens.shadows.md, // Premium Shadow
            ...
            <div key={section.label}>
              ...
              <div className="flex flex-col gap-1">
                {section.items.map((item) => {
                  ...
                  // Menu Item Rendering - VEREINHEITLICHT mit MarketingLayout
                  const menuItem = (
                    <div
                      className={cn(
                    ...
                    >
                      ...
                      {expanded && (
                        <span className="truncate whitespace-nowrap text-left flex items-center flex-1 gap-2">
                          {item.title}
                          {showUpgradeTooltip && (
