      ...
      {kpis && kpis.length > 0 && quickActions && quickActions.length > 0 && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
          ...
          <div className="lg:col-span-3">
            <Card className="border-2 border-primary/20 shadow-md hover:shadow-lg hover:border-primary/40 transition-all duration-300 h-full flex flex-col bg-gradient-to-br from-background to-primary/5 overflow-visible">
