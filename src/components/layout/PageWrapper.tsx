...
export function PageWrapper({ children, className = '' }: PageWrapperProps) {
  return (
    <div className={`min-h-screen bg-background text-foreground flex flex-col items-center justify-start px-4 sm:px-6 md:px-12 max-w-screen-xl mx-auto gap-16 py-20 ${className}`}>
      {children}
    </div>
  );
}
