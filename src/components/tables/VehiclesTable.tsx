...
export const VehiclesTable = memo(
  ({
    ...
    if (vehicles.length === 0) {
      return (
        <div className="text-center py-8 text-muted-foreground">Keine Fahrzeuge gefunden.</div>
      );
    }
        ...
        <Table>
          ...
          <TableBody>
            {formattedVehicles.map((vehicle) => {
              ...
              return (
                <TableRow key={vehicle.id} className="hover:bg-muted/50" data-selected={isSelected}>
                  ...
                  <TableCell className="hidden lg:table-cell">{vehicle.driverName}</TableCell>
                  <TableCell>
                    <StatusIndicator
