...
export const DriversTable = memo(
  ({
    ...
    if (drivers.length === 0) {
      return <div className="text-center py-8 text-muted-foreground">Keine Fahrer gefunden.</div>;
    }
        ...
        <Table>
          ...
          <TableBody>
            {formattedDrivers.map((driver) => {
              ...
              return (
                <TableRow key={driver.id} className="hover:bg-muted/50" data-selected={isSelected}>
