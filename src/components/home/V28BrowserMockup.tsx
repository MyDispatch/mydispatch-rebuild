/* ==================================================================================
   V28 BROWSER MOCKUP - V28.1 COMPLIANT (NO designTokens!)
   ==================================================================================
    ...
    <div className="relative rounded-2xl border border-slate-200 shadow-2xl overflow-hidden bg-white">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-200 bg-slate-100">
          ...
          {/* ⚠️ Design Exception: macOS-specific colors intentionally preserved */}
          <div className="flex items-center gap-2">
            <svg width="12" height="12" viewBox="0 0 12 12" className="text-red-400"> {/* macOS red */}
              <circle cx="6" cy="6" r="5" fill="currentColor" stroke="rgb(239 68 68)" strokeWidth="1"/>
            </svg>
            <svg width="12" height="12" viewBox="0 0 12 12" className="text-yellow-400"> {/* macOS yellow */}
              <circle cx="6" cy="6" r="5" fill="currentColor" stroke="rgb(250 204 21)" strokeWidth="1"/>
            </svg>
            <svg width="12" height="12" viewBox="0 0 12 12" className="text-green-400"> {/* macOS green */}
