  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto relative">
        {/* Decorative Orbs (hidden on mobile via CSS media query) */}
        <div className="home-decor-orb absolute -top-10 -right-10 w-32 h-32 bg-slate-100 rounded-full blur-3xl opacity-30 pointer-events-none" />
        <div className="home-decor-orb absolute bottom-[30%] -left-10 w-40 h-40 bg-slate-200 rounded-full blur-3xl opacity-20 pointer-events-none" />
