...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex w-full h-auto items-center bg-muted p-0 text-muted-foreground rounded-t-lg border-b border-border pointer-events-auto relative z-10",
      className,
    )}
    {...props}
  />
