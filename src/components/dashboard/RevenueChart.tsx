      ...
      <CardContent className="pt-3 pb-3">
        ...
        <div className="grid grid-cols-2 gap-2 mt-3">
          <div className="text-center p-2 rounded-lg border border-border bg-card">
            <p className="text-[9px] text-muted-foreground font-medium uppercase tracking-wide">Höchstwert</p>
            <p className="text-sm font-bold text-foreground mt-0.5">{formatCurrency(maxValue)}</p>
          </div>
          <div className="text-center p-2 rounded-lg border border-border bg-card">
            <p className="text-[9px] text-muted-foreground font-medium uppercase tracking-wide">Durchschnitt</p>
      ...
      <CardHeader className="pb-3 pt-3">
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <p className="text-[8px] text-muted-foreground uppercase tracking-wide mt-0.5">Gesamt</p>
          </div>
        </div>
      </CardHeader>
        ...
        <div className="flex items-center gap-3">
          <div className="relative w-[90px] h-[90px] flex-shrink-0">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              ...
              <span className="text-[8px] text-muted-foreground uppercase tracking-wide">Arten</span>
            </div>
          </div>
            ...
            {data.map((item, index) => (
              <div key={item.name} className="space-y-0.5">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-xs font-semibold text-foreground">{formatCurrency(item.value)}</p>
                  </div>
                </div>
                <div className="flex items-center gap-1.5">
                  <div 
                  ...
                  >
                    <div className={`chart-progress-bar chart-progress-bar--${index % 5} h-full rounded-full`} />
                  </div>
