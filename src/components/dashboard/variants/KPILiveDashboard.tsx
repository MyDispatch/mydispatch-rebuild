  ...
  return (
    <div ref={elementRef} className="w-full h-full bg-gradient-to-br from-slate-50 to-slate-100 p-6 overflow-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-600">Echtzeit-Übersicht • Letzte Aktualisierung: vor 2 Sek.</p>
      </div>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                ...
                <div className={cn(
                  ...
                  kpi.trend === 'up' ? 'bg-slate-100 text-slate-700' : 'bg-slate-100 text-slate-700'
                )}>
