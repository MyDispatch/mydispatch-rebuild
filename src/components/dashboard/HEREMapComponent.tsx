...
export function HEREMapComponent() {
  ...
  useEffect(() => {
    ...
    if (company?.latitude && company?.longitude) {
      ...
      createInfoBubble(companyMarker, `
    ...
    activeVehicles.forEach((vehicle, index) => {
      ...
      const vehicleColor = statusColors[vehicle.status as keyof typeof statusColors] || statusColors.available;
    ...
    activeBookings.forEach((booking, index) => {
      ...
      createInfoBubble(dropoffMarker, `
        <div style="padding: 10px; font-family: Inter, sans-serif; min-width: 200px;">
