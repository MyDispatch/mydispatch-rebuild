              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    activity.onClick && 'cursor-pointer hover:bg-slate-50 -ml-2 p-2 rounded-lg transition-colors duration-200'
                  )}
                  style={{ animationDelay: `${index * 30}ms` }}
                  onClick={activity.onClick}
                >
                  {/* Timeline Dot */}
                  <div className={cn('absolute left-0 w-8 h-8 rounded-lg flex items-center justify-center', colors)}>
