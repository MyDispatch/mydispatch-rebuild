    ...
    <Card className="bg-white border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200">
      <CardHeader className="pb-3">
        <div className="flex items-center gap-2">
          ...
          <CardTitle className="text-sm font-semibold text-slate-900">Tagesübersicht</CardTitle>
        </div>
      </CardHeader>
      <CardContent className="pb-3">
        <div className="grid grid-cols-3 gap-2">
          <div className="p-3 rounded-lg bg-blue-50 border border-blue-200 text-center">
            ...
            <p className="text-2xl font-bold text-blue-700 mb-1">{stats.bookings}</p>
            <p className="text-[10px] font-semibold text-blue-600">Aufträge</p>
          </div>
          ...
          <div className="p-3 rounded-lg bg-green-50 border border-green-200 text-center">
            ...
            <p className="text-2xl font-bold text-green-700 mb-1">{stats.drivers}</p>
            <p className="text-[10px] font-semibold text-green-600">Fahrer aktiv</p>
          </div>
          ...
          <div className="p-3 rounded-lg bg-purple-50 border border-purple-200 text-center">
            ...
            <p className="text-2xl font-bold text-purple-700 mb-1">{stats.vehicles}</p>
            <p className="text-[10px] font-semibold text-purple-600">Fahrzeuge</p>
          </div>
        </div>
