        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            {config.kpis.map((kpi, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="group relative bg-white rounded-2xl p-4 border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs font-medium text-slate-600 subpixel-antialiased">
                        {kpi.label}
                      </p>
                    </div>
                  </div>
            ...
            <div className="divide-y divide-slate-100">
              ...
              <div className="px-4 py-3 hover:bg-slate-50 transition-colors group">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-slate-900 antialiased">
                      Auftrag #A-2847 abgeschlossen
                    </p>
                    <p className="text-xs text-slate-600 mt-0.5 subpixel-antialiased">
                      Fahrer: Max Mustermann • München → Hamburg
                    </p>
                  </div>
              ...
              <div className="px-4 py-3 hover:bg-slate-50 transition-colors group">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-slate-900 antialiased">
                      Neuer Auftrag #A-2851 erstellt
                    </p>
                    <p className="text-xs text-slate-600 mt-0.5 subpixel-antialiased">
                      Kunde: TransLog GmbH • Berlin → Köln
                    </p>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <Clock className="w-3 h-3 text-slate-400" />
              ...
              <div className="px-4 py-3 hover:bg-slate-50 transition-colors group">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-slate-900 antialiased">
                      Verzögerung bei Auftrag #A-2849
                    </p>
                    <p className="text-xs text-slate-600 mt-0.5 subpixel-antialiased">
                      Fahrer: Anna Schmidt • Stau auf A7
                    </p>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <Clock className="w-3 h-3 text-slate-400" />
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-white rounded-xl p-3 border border-slate-200 shadow-sm">
              <p className="text-xs text-slate-600 mb-1 subpixel-antialiased">
                Durchschn. Fahrtzeit
              </p>
