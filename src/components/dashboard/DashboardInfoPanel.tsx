            ...
            <div className="relative z-10 flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-[10px] font-medium text-slate-900">HQ</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-2 h-2 rounded-full bg-status-success shadow-sm" />
                  <span className="text-[10px] font-medium text-slate-900">Frei</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-2 h-2 rounded-full bg-status-warning shadow-sm" />
                  <span className="text-[10px] font-medium text-slate-900">Aktiv</span>
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-2 h-2 rounded-full bg-status-error shadow-sm" />
                  <span className="text-[10px] font-medium text-slate-900">Service</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative z-10 flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-slate-900">Aufträge</span>
                </div>
