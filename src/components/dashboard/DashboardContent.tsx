...
function GenericDashboard({ title, kpis }: { title: string; kpis: { label: string; value: string; icon: typeof Car }[] }) {
  return (
        ...
        <div className="p-6 space-y-6 bg-white">
          <div className="flex items-center justify-between border-b border-slate-200 pb-4">
            ...
            <div className="px-2 py-1 rounded-lg bg-green-100 ring-1 ring-green-200">
              <span className="font-sans text-xs font-bold text-green-700">Live</span> {/* ✅ Status Exception */}
            </div>
          </div>
