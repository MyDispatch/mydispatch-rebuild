  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Konfigurieren Sie Rechnungs- und Zahlungsparameter
        </CardDescription>
      </CardHeader>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setCompanyData({ ...companyData, quote_start_number: parseInt(e.target.value) })}
              className="min-h-[44px] touch-manipulation"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setCompanyData({ ...companyData, payment_term_days: parseInt(e.target.value) })}
              className="min-h-[44px] touch-manipulation"
            />
          </div>

          <div className="space-y-2">
            <Label htmlFor="reminder_before_due_days">Zahlungserinnerung vor Fälligkeit (Tage)</Label>
            <Input
              id="reminder_before_due_days"
              type="number"
              value={companyData.reminder_before_due_days || 3}
              onChange={(e) => setCompanyData({ ...companyData, reminder_before_due_days: parseInt(e.target.value) })}
              className="min-h-[44px] touch-manipulation"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setCompanyData({ ...companyData, discount_term_days: parseInt(e.target.value) })}
              className="min-h-[44px] touch-manipulation"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setCompanyData({ ...companyData, discount_percentage: parseFloat(e.target.value) })}
              className="min-h-[44px] touch-manipulation"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setCompanyData({ ...companyData, default_vat_rate: parseFloat(e.target.value) })}
              className="min-h-[44px] touch-manipulation"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setCompanyData({ ...companyData, quote_validity_days: parseInt(e.target.value) })}
              className="min-h-[44px] touch-manipulation"
            />
          </div>
        </div>
