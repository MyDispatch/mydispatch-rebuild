...
export function TariffSwitcher() {
  ...
  const handleSwitch = async () => {
    if (!company?.id) {
      handleError(
        new Error("Unternehmensdaten nicht gefunden"),
  ...
  return (
    <Card className="border-2 border-primary/20 bg-primary/5">
      <CardHeader>
        ...
        <CardDescription>Wechseln Sie zwischen Tarifen für Testing-Zwecke</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <Alert>
          <AlertDescription>
            Diese Funktion ist nur für Test-Accounts verfügbar und erlaubt das freie Wechseln
            zwischen Tarifen ohne Bezahlung.
          </AlertDescription>
        </Alert>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value: "starter" | "business") => setSelectedTariff(value)}
          >
            <SelectTrigger>
