  ...
  return (
    <>
      ...
      <div ref={(el) => el && (layersRef.current[2] = el)} className="parallax-layer absolute inset-0">
        ...
        >
          <svg className="w-24 h-24 text-slate-400/15 rotate-12" fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24">
        ...
        <div 
          ...
          style={{ animationDuration: '12s', animationDelay: '2s' }}
        >
          <svg className="w-20 h-20 text-slate-400/15" fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24">
        ...
        >
          <svg className="w-32 h-32 text-slate-300/10 -rotate-6" fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24">
            <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2" />
            <circle cx="7" cy="17" r="2" />
            <path d="M9 17h6" />
            <circle cx="17" cy="17" r="2" />
      ...
      <div ref={(el) => el && (layersRef.current[3] = el)} className="parallax-layer absolute inset-0">
        {/* Glow Top Left */}
        <div 
          className="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-radial from-slate-200/60 to-transparent rounded-full blur-3xl"
        />
        
        {/* Glow Bottom Right */}
        <div 
          className="absolute bottom-0 right-0 w-[700px] h-[700px] bg-gradient-radial from-slate-300/50 to-transparent rounded-full blur-3xl"
        />
        
        {/* Glow Top Right */}
        <div 
          className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-radial from-slate-200/40 to-transparent rounded-full blur-3xl"
        />
        
        {/* Glow Bottom Left */}
        <div 
          className="absolute bottom-0 left-0 w-[550px] h-[550px] bg-gradient-radial from-slate-300/45 to-transparent rounded-full blur-3xl"
        />
      </div>
