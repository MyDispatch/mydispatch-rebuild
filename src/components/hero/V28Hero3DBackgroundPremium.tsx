  ...
  return (
    <>
      ...
      >
        ...
        >
          <svg
            className="w-28 h-28 text-slate-400/20 rotate-12"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        >
          <svg
            className="w-36 h-36 text-slate-300/15 -rotate-6"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
            <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2M7 15a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm10 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4z" />
      ...
      >
        {/* Glow Top Left */}
        <div className="absolute top-0 left-0 w-[700px] h-[700px] bg-gradient-radial from-slate-200/70 to-transparent rounded-full blur-3xl" />

        {/* Glow Bottom Right */}
        <div className="absolute bottom-0 right-0 w-[800px] h-[800px] bg-gradient-radial from-slate-300/60 to-transparent rounded-full blur-3xl" />

        {/* Glow Top Right */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-radial from-slate-200/50 to-transparent rounded-full blur-3xl" />

        {/* Glow Bottom Left */}
        <div className="absolute bottom-0 left-0 w-[650px] h-[650px] bg-gradient-radial from-slate-300/55 to-transparent rounded-full blur-3xl" />

        {/* Center Premium Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] bg-gradient-radial from-slate-400/40 to-transparent rounded-full blur-3xl" />
      </div>
