...
interface HEREMapProps {
  ...
  zoom?: number;
  markers?: Array<{ lat: number; lng: number; label?: string; color?: string; onClick?: () => void }>;
  routes?: Array<{ from: { lat: number; lng: number }; to: { lat: number; lng: number } }>;
  className?: string;
  onMapReady?: (mapInstance: any) => void;
}

export const HEREMap = ({ center, zoom = 12, markers = [], routes = [], className = '', onMapReady }: HEREMapProps) => {
