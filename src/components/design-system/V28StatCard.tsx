...
export function V28StatCard({ label, value, change, icon, onClick, className }: V28StatCardProps) {
  const TrendIcon =
    change?.trend === "up" ? TrendingUp : change?.trend === "down" ? TrendingDown : Minus;
    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between">
        <div className="flex-1">
          <p className="text-sm font-semibold mb-3 text-slate-600">{label}</p>
