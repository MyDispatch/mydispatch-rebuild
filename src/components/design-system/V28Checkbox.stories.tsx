...
export const LongText: Story = {
  args: {
    ...
    description:
      "Ihre Daten werden gemäß der Datenschutz-Grundverordnung (DSGVO) verarbeitet. Sie haben jederzeit das Recht auf Auskunft, Berichtigung und Löschung Ihrer personenbezogenen Daten.",
  },
};
