...
export function QuickActions({
  ...
  const content = (
    <div
      className={cn(
        layout === "grid" ? `grid ${gridCols[columns]} gap-3 sm:gap-4` : "space-y-2 sm:space-y-3",
        className
      )}
    >
        ...
        return (
          <V28Button
            ...
            className={cn(
              ...
              layout === "grid" &&
                "flex-col items-center justify-center text-center h-auto py-4 sm:py-6",
              action.disabled &&
          ...
          >
            ...
            {/* Content */}
            <div className={cn(layout === "grid" && "space-y-1")}>
              <span
                className={cn(
                  "font-medium",
