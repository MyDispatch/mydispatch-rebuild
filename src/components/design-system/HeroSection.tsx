...
export function HeroSection({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className={cn("relative z-10 px-4 sm:px-6 lg:px-8 text-center mx-auto", styles.content)}>
        <div
          className={cn(
        ...
        >
          ...
          {badge && (
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-5 py-1.5 sm:py-2.5 rounded-full bg-primary/95 backdrop-blur-sm shadow-lg">
              {badge.icon && <badge.icon className="h-4 w-4 sm:h-5 sm:w-5 text-foreground" />}
          ...
          {/* Title */}
          <h1 className={cn("font-bold leading-tight tracking-tight", styles.title)}>
            {variant === "marketing" ? (
              <>
                ...
                {subtitle && (
                  <span
                    className={cn("block mt-2 sm:mt-3 md:mt-4 text-foreground", styles.subtitle)}
                  >
                    {subtitle}
                  </span>
                )}
          ...
          {(primaryCTA || secondaryCTA) && (
            <div
              className={cn("flex items-center justify-center pt-4 sm:pt-8", styles.ctaContainer)}
            >
              {primaryCTA && (
                <V28Button
                ...
                >
                  {primaryCTA.icon && <primaryCTA.icon className="h-4 w-4 sm:h-5 sm:w-5" />}
                  {primaryCTA.text}
                </V28Button>
              )}
