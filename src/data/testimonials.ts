...
export const testimonials: Testimonial[] = [
  ...
  {
    quote: "MyDispatch hat unsere Disposition revolutioniert. Die Bedienung ist intuitiv und wir haben unsere Effizienz um 40% gesteigert.",
    company: "Mietwagenunternehmen Hamburg",
    rating: 5
  },
  {
    quote: "Die Partner-Funktionen haben uns die Zusammenarbeit mit anderen Unternehmen enorm erleichtert.",
    company: "Mietwagenunternehmen München",
    rating: 5
  },
  {
    quote: "Perfekte Lösung für unser Premium-Mietwagengeschäft. Live-Tracking und Verkehrsdaten sind Gold wert.",
    company: "Mietwagenunternehmen Frankfurt",
    rating: 5
  },
  {
    quote: "Endlich eine Software, die alle unsere Anforderungen erfüllt. Rechnungsstellung in Sekunden!",
  ...
  {
    quote: "Die Integration mit unserem Kunden-Portal war kinderleicht. Unsere Kunden lieben die Online-Buchung.",
  ...
  {
    quote: "Für unseren Limousinen-Service ist MyDispatch die perfekte Lösung. Premium-Features für Premium-Kunden.",
  ...
  {
    quote: "Angebotserstellung und Kundenkommunikation auf höchstem Niveau. Genau das, was wir brauchen.",
  ...
  {
    quote: "Wir können unseren Service jetzt professionell skalieren. MyDispatch wächst mit uns mit.",
  ...
  // TAXIUNTERNEHMEN (10)
  {
    quote: "DSGVO-konform, Made in Germany – das war uns wichtig. MyDispatch erfüllt alle Anforderungen perfekt.",
