...
export const PRICING_TIERS: PricingTier[] = [
  {
    ...
    priceNumeric: 39,
    yearlyPrice: '374,40 €',
    yearlyPriceNumeric: 374.40,
    billing: 'pro Monat',
    description: 'Ideal für kleine Flotten bis 3 Fahrzeuge. Alle Basis-Features für professionelle Disposition. Erweiterbar mit Fleet & Driver Add-On.',
    features: [
      ...
      { name: 'Fleet & Driver Add-On', included: 'Optional', tooltip: '9€/Monat pauschal für beliebig viele Fahrzeuge/Fahrer' },
  ...
  },
  {
    ...
    priceNumeric: 99,
    yearlyPrice: '950,40 €',
    yearlyPriceNumeric: 950.40,
    billing: 'pro Monat',
    description: 'Für wachsende Unternehmen. Keine Begrenzung bei Fahrzeugen und Fahrern. Erweiterte Features für maximale Effizienz.',
    popular: true,
    features: [
  ...
  },
  {
    ...
    description: 'Maßgeschneiderte Lösungen für Großflotten ab 50 Fahrzeugen. Keine Begrenzung der Ressourcen und Premium-Support.',
    features: [
...
export const FEATURE_COMPARISON_TABLE = [
  {
    ...
    features: [
      { name: 'Auftragsverwaltung', starter: 'Keine Begrenzung', business: 'Keine Begrenzung', enterprise: 'Keine Begrenzung' },
      { name: 'Fahrzeuge', starter: 'Max. 3', business: 'Keine Begrenzung', enterprise: 'Keine Begrenzung' },
      { name: 'Fahrer', starter: 'Max. 3', business: 'Keine Begrenzung', enterprise: 'Keine Begrenzung' },
