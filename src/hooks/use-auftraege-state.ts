...
export const useAuftraegeState = () => {
  ...
  const getState = useCallback(
    <K extends keyof AuftraegePageState>(key: K): AuftraegePageState[K] => {
  ...
  const setState = useCallback(
    <K extends keyof AuftraegePageState>(key: K, value: AuftraegePageState[K]) => {
  ...
  return {
    ...
    setSelectedPartnerForBooking: (value: string | null) =>
      setState("selectedPartnerForBooking", value),
  };
};
