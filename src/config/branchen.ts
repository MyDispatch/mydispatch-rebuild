...
export const BRANCHEN = [
  {
    ...
    slug: "taxi",
    description:
      "Optimiert für klassische Taxiunternehmen mit Funkintegration, Taxameter-Anbindung und P-Schein-Verwaltung.",
    heroTitle: "Die perfekte Lösung für Taxiunternehmen",
    heroSubtitle:
      "Professionelle Disposition mit Funkintegration, GPS-Tracking und vollständiger DSGVO-Konformität.",
  ...
  },
  {
    ...
    slug: "mietwagen",
    description:
      "Speziell für Mietwagen mit Voranmeldung: Buchungssystem, Tourenplanung und Firmenkundenverwaltung.",
    heroTitle: "Die ideale Software für Mietwagen-Services",
    heroSubtitle:
      "Professionelle Buchungsverwaltung für Voranmeldungen mit Tourenplanung und Firmenkundenmodul.",
  ...
  },
  {
    ...
    slug: "limousinen",
    description:
      "Premium-Funktionen für Limousinenservices: VIP-Kundenmanagement, exklusive Fahrzeugverwaltung.",
    heroTitle: "Premium-Software für Limousinen-Services",
    heroSubtitle:
      "Exklusive Funktionen für VIP-Kunden, Event-Management und Luxus-Fahrzeugverwaltung.",
