...
export const routes: RouteConfig[] = [
  // ========== PUBLIC ROUTES (NO AUTH) ==========
  {
    ...
    meta: {
      ...
      description:
        "Moderne Cloud-Lösung für professionelle Disposition. GPS-Tracking, Auftragsverwaltung, automatische Rechnungsstellung. DSGVO-konform, Made in Germany.",
    },
  },
  ...
  },
  {
    ...
    meta: {
      title: "Features",
      description:
        "Alle MyDispatch Features im Überblick: GPS-Tracking, Disposition, Kundenverwaltung und mehr",
    },
  },
  {
    path: "/demo",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Erweitern Sie Ihre Flotte flexibel - 9€/Monat pro zusätzlichem Fahrzeug oder Fahrer",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "39€/Monat für Einsteiger. GPS-Tracking, Disposition, Kundenverwaltung. Ideal für 1-3 Fahrzeuge.",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "99€/Monat für wachsende Betriebe. Alle Starter-Features plus Partner-Netzwerk, White-Label, Business Intelligence.",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Individuelle Lösungen für Großflotten. API-Zugriff, Dedicated Support, maßgeschneiderte Features. Preis auf Anfrage.",
    },
  },
  {
    path: "/faq",
