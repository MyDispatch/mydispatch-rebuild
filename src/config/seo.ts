...
export const SEO_DEFAULTS = {
  ...
  defaultDescription: 'Moderne Dispositions-Software für Taxi- und Mietwagen-Services. GPS-Tracking, Auftragsverwaltung, Rechnungsstellung und mehr. DSGVO-konform, Made in Germany.',
...
export const PAGE_SEO = {
  home: {
    ...
    description: 'Moderne Cloud-Lösung für professionelle Disposition. GPS-Tracking, Auftragsverwaltung, automatische Rechnungsstellung und mehr. DSGVO-konform, Made in Germany.',
    keywords: [
  ...
  pricing: {
    ...
    description: 'Klar strukturierte, faire Tarife für Taxi- und Mietwagen-Services. DSGVO-konform, Made in Germany. Jederzeit kündbar.',
    keywords: [
  ...
  features: {
    ...
    description: 'Alle Features der professionellen Dispositions-Software im Überblick. GPS-Tracking, Auftragsverwaltung, Rechnungsstellung und vieles mehr.',
    keywords: [
  ...
  contact: {
    ...
    description: 'Nehmen Sie Kontakt mit uns auf. Wir beraten Sie gerne zu unserer Dispositions-Software für Taxi- und Mietwagen-Services.',
    keywords: [
      'MyDispatch Kontakt',
      'Taxi Software Support',
      'Dispositionssoftware Beratung',
    ],
  },
  demo: {
    title: 'Demo anfragen – MyDispatch',
    description: 'Fordern Sie eine unverbindliche Demo an und erleben Sie MyDispatch live. Wir zeigen Ihnen alle Funktionen und Features unserer Software.',
    keywords: [
      'MyDispatch Demo',
      'Taxi Software Demo',
      'Dispositionssoftware testen',
    ],
  },
  auth: {
    title: 'Anmelden – MyDispatch',
    description: 'Melden Sie sich bei MyDispatch an und verwalten Sie Ihre Taxi- oder Mietwagen-Services effizient.',
