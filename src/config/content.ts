...
export const CONTENT_META = {
  ...
  defaultDescription: 'Professionelle Dispositions-Software für Taxi-, Mietwagen- und Limousinen-Services. GPS-Tracking, Auftragsverwaltung, Rechnungsstellung - alles in einer Lösung.',
} as const;
...
export const HERO_CONTENT = {
  ...
  description: 'GPS-Tracking, Auftragsverwaltung & Rechnungsstellung - alles in einer Lösung. Made in Germany.',
