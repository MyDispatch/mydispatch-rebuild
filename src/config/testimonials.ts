...
export const TESTIMONIALS = [
  {
    ...
    quote:
      "MyDispatch hat unsere Prozesse revolutioniert. Die GPS-Ortung in Echtzeit und die automatische Abrechnung sparen uns täglich mehrere Stunden.",
    rating: 5,
  ...
  },
  {
    ...
    role: "Inhaberin",
    quote:
      "Besonders das VIP-Kundenmanagement und die White-Label-Lösung haben unseren Service auf ein neues Level gehoben.",
    rating: 5,
  ...
  },
  {
    ...
    quote:
      "Die Integration war reibungslos und der Support ist erstklassig. Wir können MyDispatch jedem Mietwagenunternehmen empfehlen.",
    rating: 5,
