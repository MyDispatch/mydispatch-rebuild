...
export const FEATURES = [
  ...
  },
  {
    ...
    description: 'Live-Ortung aller Fahrzeuge auf interaktiver Karte mit Routenverfolgung und Geofencing.',
    icon: 'MapPin',
    benefits: [
  ...
  },
  {
    ...
    shortTitle: 'API',
    description: 'Offene REST API für Drittanbieter-Integrationen und Schnittstellen zu Partnersystemen.',
    icon: 'Code',
    benefits: [
      'RESTful API',
      'Webhooks',
  ...
  },
  {
    ...
    description: 'Automatisieren Sie wiederkehrende Aufgaben und sparen Sie Zeit mit intelligenten Workflows.',
    icon: 'Zap',
    benefits: [
...
export const MAIN_FEATURES = FEATURES
  .filter(f => f.showOnHomepage && f.priority <= 6)
  .sort((a, b) => a.priority - b.priority) as Feature[];
