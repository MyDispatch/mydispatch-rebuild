...
export const HOME_PAGE_CONFIG: PreLoginPageConfig = {
  seo: {
    ...
    description:
      "Professionelle Cloud-Lösung für Taxi- und Mietwagenunternehmen. Optimierte Disposition, GPS-Tracking, Auftrags- und Fahrzeugverwaltung. Kostenfreier Test verfügbar.",
    keywords: [
      "Taxi Software",
      "Mietwagen Software",
  ...
  hero: {
    ...
    description:
      "Steigern Sie Effizienz und Umsatz mit intelligenter Auftragsplanung, GPS-Tracking und automatisierten Workflows.",
      ...
      tiers: [
        {
          ...
          features: ["Bis zu 5 Fahrzeuge", "Basis Disposition", "GPS-Tracking", "E-Mail Support"],
        },
        {
          name: "Business",
          price: "149€",
        ...
        },
        {
          ...
          features: ["Unbegrenzte Fahrzeuge", "White-Label", "Dedizierter Manager", "24/7 Support"],
        },
      ],
    },
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Ja, MyDispatch ist vollständig DSGVO-konform. Alle Daten werden in Deutschland gehostet.",
        },
        {
          question: "Welche Zahlungsmethoden werden akzeptiert?",
          answer:
            "Wir akzeptieren alle gängigen Zahlungsmethoden: SEPA-Lastschrift, Kreditkarte und Rechnung.",
        },
      ],
    },
  },
...
export const PRICING_PAGE_CONFIG: Partial<PreLoginPageConfig> = {
  seo: {
    ...
    description:
      "Vergleichen Sie unsere Tarife und finden Sie die perfekte Lösung für Ihr Unternehmen.",
  },
  hero: {
    variant: "pricing",
    title: "Transparente Preise",
...
export const FEATURES_PAGE_CONFIG: Partial<PreLoginPageConfig> = {
  seo: {
    ...
    description:
      "Entdecken Sie alle Features von MyDispatch: GPS-Tracking, Auftragsmanagement, Rechnungsstellung und mehr.",
  },
  hero: {
    variant: "features",
...
export const DEMO_PAGE_CONFIG: Partial<PreLoginPageConfig> = {
  seo: {
    ...
    description:
      "Erleben Sie MyDispatch in einer persönlichen Live-Demo. Kostenlos und unverbindlich.",
  },
  hero: {
    variant: "demo",
