...
export const MOBILE_BOTTOM_NAV_ITEMS = [
  ...
  DASHBOARD_NAVIGATION[9], // Partner
] as const;
...
export const MARKETING_HEADER_NAV = MAIN_NAVIGATION.filter(
  n => n.showInDesktop
);
...
export const FEATURE_NAVIGATION = [
  {
    ...
    features: [
      ...
      { path: '/features/core/auftragsverwaltung', label: 'Auftragsverwaltung', icon: 'ClipboardList' },
  ...
  },
  {
    ...
    features: [
      ...
      { path: '/features/business/partner-management', label: 'Partner-Management', icon: 'Handshake' },
      { path: '/features/business/live-traffic', label: 'Live-Traffic & Wetter', icon: 'MapPin' },
      { path: '/features/business/statistiken', label: 'Statistiken & Reports', icon: 'TrendingUp' },
      { path: '/features/business/gps-tracking', label: 'GPS-Tracking', icon: 'Navigation' },
      { path: '/features/business/workflow-automation', label: 'Workflow-Automatisierung', icon: 'Zap' },
    ]
  },
  {
    ...
    features: [
      ...
      { path: '/features/enterprise/custom-development', label: 'Custom Development', icon: 'Code2' },
